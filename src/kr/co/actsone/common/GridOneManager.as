	...
	public class GridOneManager
	{
			...
			try
			{
				...
				{	
					...
					switch (menuItemKey)
					{
						case MenuConstants.MENUITEM_CELL_INSERT_ROW:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_INSERT_ROW_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_INSERT_ROW_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_CELL_DELETE_ROW:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_DELETE_ROW_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_DELETE_ROW_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_CELL_REMOVE_ALL:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_REMOVE_ALL_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_REMOVE_ALL_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_CELL_COPY:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_COPY_CH;
							}
							else if(Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_COPY_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_CELL_EXCELEXPORT:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_EXCELEXPORT_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_EXCELEXPORT_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_CELL_FIND:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_FIND_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_FIND_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_CELL_FIND_COLUMN:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_FIND_COLUMN_CH;
							}
							else  if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_FIND_COLUMN_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_CELL_FONTDOWN:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_FONTDOWN_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_FONTDOWN_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_CELL_FONTUP:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_FONTUP_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_FONTUP_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_CELL_PASTE:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_PASTE_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_CELL_PASTE_KR;
							}
							else
							{
				...
				else if (itemMenuType == MenuConstants.MENU_HEADER)
				{
					...
					switch (menuItemKey)
					{
						case MenuConstants.MENUITEM_HD_CANCELFIXHEADER:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_HD_CANCELFIXHEADER_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_HD_CANCELFIXHEADER_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_HD_CANCELHIDEHEADER:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_HD_CANCELHIDEHEADER_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_HD_CANCELHIDEHEADER_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_HD_FIXHEADER:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_HD_FIXHEADER_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_HD_FIXHEADER_KR;
							}
							else
							{
						...
						case MenuConstants.MENUITEM_HD_HIDEHEADER:
							if (Global.DEFAULT_LANG=="CH")
							{
								item["label"] = MenuConstants.MENU_NAME_HD_HIDEHEADER_CH;
							}
							else if (Global.DEFAULT_LANG=="KR")
							{
								item["label"] = MenuConstants.MENU_NAME_HD_HIDEHEADER_KR;
							}
							else
							{
				...
				else if (itemMenuType == MenuConstants.MENU_ROW_SELECTOR)
				{
					...
					if (menuItemKey == MenuConstants.MENUITEM_ROW_COPY)
					{
						if (Global.DEFAULT_LANG=="CH")
						{
							item["label"] = MenuConstants.MENU_NAME_ROW_COPY_CH;
						}
						else if (Global.DEFAULT_LANG=="KR")
						{
							item["label"] = MenuConstants.MENU_NAME_ROW_COPY_KR;
						}
						else
						{
		...
		public function checkDataProvider(provider:Object, bValidation:Boolean, parentFunName:String):void
		{
			try
			{
				...
				if (originData.length >10 && this.datagrid.isTree==false)
				{
				...
				if (bhaft==true)
				{
					for(var k:int=2;k<originData.length;k++)
					{
		...
		/*************************************************************
		 * get data from array
		 * @param rows are row index
		 * @return ArrayCollection of data
		 * ***********************************************************/
		...
		*/
		...
		/*************************************************************
		 * set language for use as global. 
		 * The export/import will be change language and the context menu as well.
		 * @author Chheav Hun
		 * ***********************************************************/
		public function setLanguage(lang:String):void
		{
 
			removeAllContextMenuItem(MenuConstants.MENU_CELL);
			removeAllContextMenuItem(MenuConstants.MENU_ROW_SELECTOR);
			removeAllContextMenuItem(MenuConstants.MENU_HEADER);
