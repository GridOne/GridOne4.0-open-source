...
import kr.co.actsone.accessibility.ExAdvancedDataGridAccImpl;
import kr.co.actsone.common.ColumnType;
import kr.co.actsone.common.ExIHierarchicalData;
import kr.co.actsone.common.Global;
import kr.co.actsone.common.IFilter;
import kr.co.actsone.common.MergeCellInfo;
import kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridBaseSelectionData;
import kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridBaseSelectionPending;
import kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridColumn;
import kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridColumnGroup;
import kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridFooter;
...
import kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridRendererDescription;
import kr.co.actsone.controls.advancedDataGridClasses.ExSortInfo;
import kr.co.actsone.controls.advancedDataGridClasses.IExAdvancedDataGridRendererProvider;
...
import kr.co.actsone.export.StylesInfor;
import kr.co.actsone.filters.Filter;
import kr.co.actsone.importcsv.CSV;
...
import kr.co.actsone.utils.LogManager;
...
*
*  @eventType mx.events.ExAdvancedDataGridEvent.ITEM_CLOSE
*  
*  @langversion 3.0
...
*/
[Event(name="itemClose", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]

/**
*  Dispatched when a branch of the navigation tree is opened or expanded.
*
*  @eventType mx.events.ExAdvancedDataGridEvent.ITEM_OPEN
*  
*  @langversion 3.0
*  @playerversion Flash 9
*  @playerversion AIR 1.1
*  @productversion Flex 3
*/
[Event(name="itemOpen", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]

/**
*  Dispatched when a tree branch open or close operation is initiated.
*
*  @eventType mx.events.ExAdvancedDataGridEvent.ITEM_OPENING
*  
*  @langversion 3.0
*  @playerversion Flash 9
*  @playerversion AIR 1.1
*  @productversion Flex 3
*/
[Event(name="itemOpening", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]

/**
*  Dispatched when the user drags a column outside of its column group.
*  The ExAdvancedDataGrid control does not provide a default event handler for this event.
*
*  @eventType mx.events.ExAdvancedDataGridEvent.HEADER_DRAG_OUTSIDE
*  
*  @langversion 3.0
*  @playerversion Flash 9
*  @playerversion AIR 1.1
*  @productversion Flex 3
*/
[Event(name="headerDragOutside", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]

/**
*  Dispatched when the user drops a column outside of its column group.
*  The ExAdvancedDataGrid control doesn't provide a default handler for this event.
*
*  @eventType mx.events.ExAdvancedDataGridEvent.HEADER_DROP_OUTSIDE
*  
*  @langversion 3.0
*  @playerversion Flash 9
*  @playerversion AIR 1.1
*  @productversion Flex 3
*/
[Event(name="headerDropOutside", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
[Event(name="dgcollectionChange", type="kr.co.actsone.events.SAEvent")]
//--------------------------------------
//  Styles
//--------------------------------------
...
*  For the ExAdvancedDataGrid controls, 
...
*  of the ExAdvancedDataGrid control, in descending order.
*
*  @default undefined
*  
*  @langversion 3.0
...
*  and icon parts of a header in a ExAdvancedDataGrid control.
*
*  @default undefined
*  
*  @langversion 3.0
...
*  separators between column headers of different depth in a ExAdvancedDataGrid control.
*
*  @default undefined
*  
*  @langversion 3.0
...
/**
*  The font family used by the ExAdvancedDataGridSortItemRenderer class 
...
/**
*  The font size used by the ExAdvancedDataGridSortItemRenderer class 
*  to render the sort icon in the column header.
*
*  @default 10
*  
...
/**
*  The font style used by the ExAdvancedDataGridSortItemRenderer class 
*  to render the sort icon in the column header.
*
*  @default normal
*  
...
/**
*  The font weight used by the ExAdvancedDataGridSortItemRenderer class 
*  to render the sort icon in the column header.
*
*  @default normal
*  
 ...
 * **************************************************************************/
/**
 *  The header text align used by the ExAdvancedDataGridHeaderRenderer class 
 *  to render text in the column header.
 *
 *  @default left
 *  
 *  @langversion 3.0
 ...
 *  @productversion Flex 3
 */
[Style(name="headerTextAlign", type="String", enumeration="left,center,right", inherit="no")]
/**
 *  The header background color used by the ExAdvancedDataGridHeaderRenderer class 
 *  to render background in the column header.
 *
 *  @default #FFFFFF
 *  
 *  @langversion 3.0
 ...
 *  @productversion Flex 3
 */
[Style(name="headerBackgroundColor", type="uint", format="Color", inherit="no")]
/**
 *  The header color used by the ExAdvancedDataGridHeaderRenderer class 
 *  to render color of text in the column header.
 *
 *  @default #0B333C
 *  
 *  @langversion 3.0
...
//for context menu:
[Style(name="contextMenuColor", type="uint", format="Color", inherit="yes")]
[Style(name="contextMenuFontFamily", type="String", inherit="yes")]
[Style(name="contextMenuFontSize", type="Number", format="Length", inherit="yes")]
[Style(name="contextMenuFontStyle", type="String", enumeration="normal,italic", inherit="yes")]
[Style(name="contextMenuFontWeight", type="String", enumeration="normal,bold", inherit="yes")]

//for context menu cell find column color:
[Style(name="ctxMenuCellFindColumnColor", type="uint", format="Color", inherit="yes")]
[Style(name="ctxMenuCellFindColumnSize", type="Number", format="Length", inherit="yes")]
[Style(name="ctxMenuCellFindColumnFontFamily", type="String", inherit="yes")]
...
/**
*  The ExAdvancedDataGrid control expands on the functionality of the standard DataGrid control 
...
*
 *  The <code>ExAdvancedDataGrid</code> control is like a List control except that it can show 
 *  more than one column of data,
 *  making it suited for showing objects with multiple properties.
 *  <p>
 *  The ExAdvancedDataGrid control provides the following features:
 *  <ul>
 ...
 *  </ul>
 *  </p>
 *  The ExAdvancedDataGrid control is intended for viewing data, and not as a
 *  layout tool like an HTML table.
 *  The mx.containers package provides those layout tools.
 *  
 *  @mxml
 *  <p>
 *  The <code>&lt;mx:ExAdvancedDataGrid&gt;</code> tag inherits all of the tag attributes
 ...
 *    groupItemRenderer="ExAdvancedDataGridGroupItemRenderer"
 ...
 *  /&gt;
 *   
 *  <b><i>The following ExAdvancedDataGrid code sample specifies the column order:</i></b>
 *  &lt;mx:ExAdvancedDataGrid&gt;
 *    &lt;mx:dataProvider&gt;
 ...
 *    &lt;/mx:dataProvider&gt;
 *    &lt;mx:columns&gt;
 *        &lt;mx:ExAdvancedDataGridColumn dataField="Album"/&gt;
 *        &lt;mx:ExAdvancedDataGridColumn dataField="Price"/&gt;
 *    &lt;/mx:columns&gt;
 *  &lt;/mx:ExAdvancedDataGrid&gt;
 *  </pre>
 *  </p>
 *
 *  @see kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridItemRenderer
 *  @see kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridColumn
 *  @see kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridDragProxy
 ...
 *  @productversion Flex 3
 */
public class ExAdvancedDataGrid extends ExAdvancedDataGridBaseEx
{
     ...
     * the <code>ExAdvancedDataGridHeaderRenderer.mouseEventToHeaderPart</code> method.
     *  
     *  @langversion 3.0
     *  @playerversion Flash 9
     *  @playerversion AIR 1.1
	...
	//for import:
	//--------------------------------------------------------------------------
	public var strImportColumnKeyList: String;
	public var bTrimBottom: Boolean;
	public var bIgnoreHeaderImport: Boolean;
	public var bCharset: Boolean;
	public var dateExcelImportFormat: String;
	
	public var strDefaultImportFileFilter:String="csv";
	public var strDefaultExportFileFilter:String="xls";
	public var strDefaultExportFileName:String="datagrid";
	public var styleHeader:StyleHeader;
	public var styleFooter:StyleFooter;
	public var subHeaderStyle:Array; 
	private var _excelTemplate:String;
	
	private var err:ErrorMessages=new ErrorMessages();
	
	
	//chheavhun add for set padding to header
	public var headerRightPadding:Number=0;
	
	//chheavhun add for cell border
	public var cellBorderWidth:Number=0;
	public var cellBorderColor:uint;
	
	public function get excelTemplate():String
	{
		return _excelTemplate;
	}
	
	public function set excelTemplate(value:String):void
	{
	...
	public function getParamCount():int
	{
		if (params != null)
		{
			...
			return objectInfo.properties.length;
		}
		return 0;
	}
	...
	private var _logManager:LogManager = new LogManager(this);
	
	public function get logManager():LogManager
	{
		return _logManager;
	}
	
	public function set logManager(value:LogManager):void
	{
		_logManager = value;
	}
	...
	private var _isDoQuery:Boolean=false; 
	
	public function get isDoQuery():Boolean
	{
		return _isDoQuery;
	}
	
	public function set isDoQuery(value:Boolean):void
	{
		_isDoQuery = value;
	}
	
	private var _isGettingData:Boolean=false;
	
	public function get isGettingData():Boolean
	{
		return _isGettingData;
	}
	
	public function set isGettingData(value:Boolean):void
	{
	 ...
	 *  Context menu.
	 */
	public var bContextMenuVisible:Boolean=true;		
	public var bUseDefaultContextMenu:Boolean=true;		
	public var bUserContextMenu:Boolean=false;
	[Bindable]
	public var cellContextMenu:ArrayCollection = new ArrayCollection();
	[Bindable]
	public var headerContextMenu:ArrayCollection = new ArrayCollection();
	
	public var _bkDP:Object;
	
	public var bHDDblClickAction:Boolean;
	public var _isGroupedColumn:Boolean = false;
	private var _strHDSizing:String="";
	
	//		public var IdDataFiebld:String="";
	[Bindable] public var selectCell:Boolean = true;
	public var nCellPadding:Number=5;
	
	public var isSelectCalendar:Boolean=false;
	protected var selectedItemPos:Object=null;
	
	/**
	 * Tree
	 */
	public var treeInfo:Array;
	public var treeIDField:String="TREEIDFIELD";
	public var treePIDField:String="TREEPIDFIELD";
	public var treeTypeField:String="TREETYPEFIELD";
	public var hiddenValue:String = "HIDDENVALUE";
	public var treeDataField:String="";
	public var isTree:Boolean = false;
	public var enableTreeClickAction:Boolean = true;
	/**		
	 * values for clicking header:select|sortsingle|sortmulti
	 */
	private var _strHDClickAction:String="sortsingle";
	
	public var isEditable:Boolean=true;
	public var _cellDict:Dictionary=new Dictionary();
	
	/**
	 * CRUD mode
	 */
	public var crudMode:Boolean;
	public var crudColumnKey:String="";
	public var strInsertRowText:String="C";
	public var strUpdateRowText:String="U";
	public var strDeleteRowText:String="D";				
	public var crudProvider:ArrayCollection;
	public var bViewDelRowCRUD:Boolean = false;
	/**
	 * Image list
	 */
	...
	/* activation */
	public var bItemEditBegin:Boolean = false;
	
	public var strAlternateRowsFgColor:Array = new Array();
	
	public var mouseWheelPageSize:int=3;
	private var _strMouseWheelAction:String="default";
 
	
	public function get strMouseWheelAction():String
	{
		return _strMouseWheelAction;
	}
	
	public function set strMouseWheelAction(value:String):void
	{
		_strMouseWheelAction=value;
		if (value.toString() == Global.MOUSE_WHEEL_DEFAULT)
		{
			mouseWheelPageSize=1;
		}
		else if (value.toString() == Global.MOUSE_WHEEL_PAGE)
		{
			mouseWheelPageSize=rowCount;
		}
	}
	
	private var _bHDVisible:Boolean;
	private var _headerHeightTemp:Number;
	public function get bHDVisible():Boolean
	{
		return !this.showHeaders;
	}
	
	public function set bHDVisible(value:Boolean):void
	{
		this.showHeaders=value;
	}
	
	public var filter:IFilter = new Filter();
	
	public var bHDFontCLine:Boolean = true;
	public var bCellFontCLine:Boolean = true;
	
	//save these last selected item
	public var lastSelectedItem:Object = {};
	
	// Summary bar
	public var summaryBarManager:SummaryBarManager;
	public var hasTotalColumn:Boolean=false;
	public var hasTotal : Boolean = false;
	public var hasSubTotal : Boolean = false;		
	public var lstMergeColumn : ArrayCollection; 		
	[Bindable] public var lstSummaryBar : Dictionary;
	
	public var _rowStyleDic:Dictionary=new Dictionary();
	
	// Export Excel:
	[Bindable]
	public var isMergeOrderPriority:Boolean = true;
	
	[Bindable]
	public var isDraggableCol : Boolean = true;
	[Bindable]
	public var orignalStrHDClickAction:String = "";
	
	public var strLoadingbarUrl:String="";	
	
	[Bindable] public var lstComponentBar:Array;
	protected var footer:ExAdvancedDataGridFooter;
	public var footerHeight:int = 44;
	public var hasFooterBar:Boolean = false;
	public var bOriginalExternalScroll:Boolean = false;
	[Bindable] public var totalVisibleColumnWidth:Number=0;
	/**
	 * set type of scroll when scroll
	 * value: default|syncscreen
	 */
	[Bindable] public var strRowScrollDragAction:String="syncscreen";
	
	/*************************************************************
	 * collect all events to be registerd by External Interface
	 * ***********************************************************/
	public var eventArr:Array=new Array();
	
	//property to support improvement performance
	public var performanceMode:Boolean = false;
	
	//property to support get data from GridOne in case input data is NULL or ""
	public var bUpdateNullToZero:Boolean = false;
	
	//property to support display data as zero or ""
	public var bNullValueNumberFormat:Boolean = false;
	
	//property to support get row index according to backupDataProvider or dataProvider
	public var bFilterDataIndex:Boolean = true;
	
	//property to allow to change sort text or not
	public var isChangeSortText:Boolean = true;
	
	//property to support which sort text is displayed 
	public var changeSortText:String = "";
	
	[Bindable] public var nRowHideBuffer:int=100;	//this value is maxlength of invisibleIndexOrder
	
	public var invisibleIndexOrder:Array;	//property to save all invisible index to be used in setRowHide , undoSetRowHide.
	
	//it is used in update application height when Grid has data or not
	public var isResizeDgHeightByPixel:Boolean=true;
	[Bindable] public var bAllowResizeDgHeight:Boolean=false;	//check datagrid is resize or not when data is imported
	[Bindable] public var originalAppHeight:Number;   //save the heigth of gridone when application is initalized.
	[Bindable] public var originalDgHeight:Number;   //save the heigth value when datagrid is initalized.
	[Bindable] public var nMinVisibleRow:Number=1; 	//value is used to calculated height of item rows in datagrid (follow the number of visible row)
	[Bindable] public var nMinContentHeight:Number=100;	//value is used to calculated height of datagrid in case using pixel
	/**
	 * allow resize height of application
	 * bAllowResizeDgHeight = true and bResizeHeightByApp = false: allow resize height of datagrid
	 * bAllowResizeDgHeight = true and bResizeHeightByApp = true: allow resize height of application
	 * */
	[Bindable] public var bResizeHeightByApp:Boolean = true;
	
	//Chheavhun
	public var checkboxTrueValue:String="1";
	public var checkboxFalseValue:String="0";
	
	//chheavhun add for specail case support customer
     ...
     *  @productversion Flex 3
     */
    public function ExAdvancedDataGrid()
    {
        super();
		 
        rendererDescriptionMap = new Dictionary(true);
        
        groupItemRenderer = new ClassFactory(ExAdvancedDataGridGroupItemRenderer);

        // Added Listener from Tree
        addEventListener(ExAdvancedDataGridEvent.ITEM_OPENING, expandItemHandler,
                         false, EventPriority.DEFAULT_HANDLER);

        addEventListener(FlexEvent.UPDATE_COMPLETE, updateCompleteHandler);
		
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		this.styleFunction = rowStyleFunction;
		this.selectionMode = this.selectCell ? "multipleCells" : "multipleRows";	//multipleCells
		this.editable = "all";
		this.addEventListener("clickCalendar", clickCalendarHanlder);
		this.addEventListener(ListEvent.ITEM_CLICK, dg_itemClickHandler);
		this.addEventListener(MouseEvent.DOUBLE_CLICK, dg_doubleClicHandler);
		this.addEventListener(ExAdvancedDataGridEvent.ITEM_EDIT_BEGINNING,dg_itemEditBeginningHandler);
		this.addEventListener(ExAdvancedDataGridEvent.ITEM_EDIT_END,dg_itemEditEndHandler);
		this.accessibilityImplementation = new ExAdvancedDataGridAccImpl(this);
    }
    ...
    /**
     *  @private
     *  The first ExAdvancedDataGridBaseSelectionData in a link list of
     *  ExAdvancedDataGridBaseSelectionData. This represents the item that was
     *  most recently selected.  ExAdvancedDataGridBaseSelectionData instances are
     *  linked together and keep track of the order the user selects an item.
     *  This order is reflected in selectedCells.
     */
    mx_internal var firstCellSelectionData:ExAdvancedDataGridBaseSelectionData;

    /**
     *  A hash table of ExAdvancedDataGridBaseSelectionData objects that track
     *  which items are currently selected.  The table is indexed by the UID of
     *  the items and then the column number.
     *
     *  @see mx.controls.advancedDataGridClasses.ExAdvancedDataGridBaseSelectionData
     *  
     *  @langversion 3.0
     *  @playerversion Flash 9
     *  @playerversion AIR 1.1
     ...
     *  @private
     */
    private var dropInfo:ExAdvancedDataGridEvent;
	...
	/**
	 *  @public
	 *  variable for cell border 
	 */
	public var cellBorderItemRenderer:IListItemRenderer;  
	public var cellBorderUID:String;      
	public var cellBorderColumnIndex:Number; 
	public var cellBorderSprite:Sprite;
    ...
    override public function set dataProvider(value:Object):void
    {
        ...
        if (itemEditorInstance)
            endEdit(ExAdvancedDataGridEventReason.OTHER);
		...
		var saEvent:SAEvent=new SAEvent(SAEvent.COLLECTION_CHANGE,true);
	...
	[Inspectable(category="General", arrayType="kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridColumn")]
    /**
     *  @private
     */
    ...
    {       
		...
		if (this.arrCellBorder.length > 0)
		{
			clearCellBorderAll(); 
		}
        ...
        if((!variableRowHeight && groupRowHeight != -1 && groupRowHeight != rowHeight) || ( mergeCells && mergeCells.length > 0))	// Duong add
		...
		if (mergeCells && mergeCells.length > 0)		//Duong add
		{
			invalidateDisplayList();
		}
		if (this.arrCellBorder.length > 0 )	 //chheavhun add
		{
		 	this.redrawCellBorder();
		}
    ...
    /**
     *  An Array that defines the hierarchy of ExAdvancedDataGridColumn instances when performing column grouping.
    ...
    public function set groupedColumns(value:Array):void
    {
        ...
        if(validateGroupedColumns(value))
        {
            if(_groupedColumns)
            {
                ...
                {
                    if(_groupedColumns[i] is ExAdvancedDataGridColumnGroup)
                        columnGroupRendererChanged(ExAdvancedDataGridColumnGroup(_groupedColumns[i]));
                }
            }
     ...
     *  property. This is because the ExAdvancedDataGrid control returns a new
     ...
     *  By default, it is an instance of the ExAdvancedDataGridGroupItemRenderer class. 
     *  
     *  @langversion 3.0
     *  @playerversion Flash 9
     *  @playerversion AIR 1.1
     ...
     *  and ExAdvancedDataGridColumn classes is:</p>
     *  <pre>
     *  myGroupLabelFunction(item:Object, column:ExAdvancedDataGridColumn):String</pre>
     * 
     *  <p>Where <code>item</code> contains the ExAdvancedDataGrid item object, and
     *  <code>column</code> specifies the ExAdvancedDataGrid column. 
     ...
     */
    private var _rendererProviders:Array = []; /* of ExAdvancedDataGridRendererProvider */

    /**
     *  Array of ExAdvancedDataGridRendererProvider instances. 
     ...
     *  item that is currently displayed in the top row of the ExAdvancedDataGrid control.
     ...
     *
     *  <p>The default value is the first item in the ExAdvancedDataGrid control.</p>
     *  
     *  @langversion 3.0
     *  @playerversion Flash 9
     *  @playerversion AIR 1.1
     ...
     */
    private var _treeColumn:ExAdvancedDataGridColumn = null;

    [Inspectable(category="General")]
    /**
     *  The column in which the tree is displayed.
     *  Set this property to the value of the <code>id</code> property of an
     *  ExAdvancedDataGridColumn instance, as the following example shows:
     *
     *  <pre>
     *    &lt;mx:ExAdvancedDataGrid 
     ...
     *          &lt;mx:ExAdvancedDataGridColumn id="rep" 
     ...
     *  @productversion Flex 3
     */
    public function get treeColumn():ExAdvancedDataGridColumn
    {
        if (_treeColumn)
            return _treeColumn;
     ...
     *  @private
     */
    public function set treeColumn(value:ExAdvancedDataGridColumn):void
    {
    ...
    {
        if (ExAdvancedDataGrid.createAccessibilityImplementation != null)
            ExAdvancedDataGrid.createAccessibilityImplementation(this);
    }
    ...
    */
     ...
     *
     */
    override protected function addRendererToContentArea(item:IListItemRenderer, column:ExAdvancedDataGridColumn):void
    {
        //Creating a header
        if(columnGrouping && item.data is ExAdvancedDataGridColumn)
        {
            var headerInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(item.data as ExAdvancedDataGridColumn);
    ...
    override protected function hasHeaderItemsCreated(index:int=-1):Boolean
    {
        ...
        var headerInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(getOptimumColumns()[index]);
        ...
        else
        {
            if(headerItemsList && headerItemsList.length)
            {
                while (headerItemsList.length)
                {
                    ...
                    addHeaderToFreeItemRenderers(item, item.data as ExAdvancedDataGridColumn);
                }
            }
        }
    }
    ...
    {       
        if(!columnGrouping)
        {
            ...
            if (creatingHeaders)
            {
                ...
                var lastCol:ExAdvancedDataGridColumn = displayableColumns[lastColIndex];
        ...
        else
        {
            if(visibleHeaderInfos && (!visibleHeaderInfos[0].headerItem || (top < visibleHeaderInfos[0].headerItem.y + visibleHeaderInfos[0].headerItem.height)))
            {
                ...
                var visibleHeaderInfo:ExAdvancedDataGridHeaderInfo;
     ...
     *
     *  @param c The ExAdvancedDataGridColumn instance for the column.
     *
     ...
     *  @productversion Flex 3
     */
    override mx_internal function getRenderer(c:ExAdvancedDataGridColumn, itemData:Object, forDragProxy:Boolean = false):IListItemRenderer
    {
    ...
    override mx_internal function getWidthOfItem(item:IListItemRenderer,
                                                 col:ExAdvancedDataGridColumn, visibleColumnIndex:int):Number
    {
        var ww:Number = 0;
        var adgDescription:ExAdvancedDataGridRendererDescription = rendererDescriptionMap[item] as ExAdvancedDataGridRendererDescription;
        if (adgDescription && adgDescription.renderer)
        {
            var i:int;
            var end:int;
            ...
            if (adgDescription.columnSpan == 0)
            {
                ...
                {
                    tmpWidth += ExAdvancedDataGridColumn(_columns[i]).width;
                }
                ww = tmpWidth;
            }
            else
        ...
        {
			//Duong add here to check fixedLastColumn when performanceMode=fast
			if(!checkFixedLastColumnWithHScrollBar())
            	return (isNaN(col.explicitWidth) ? col.preferredWidth : col.explicitWidth) + getLastColumnResidualWidth();
			else
				return (isNaN(col.explicitWidth) ? col.preferredWidth : col.width);
        }
        else
        {
    ...
    override protected function createHeaderSeparators(n:int, separators:Array, headerLines:UIComponent):void
    {
        ...
        else
        {
            ...
            for (var i:int = 0; i < n; i++)
            {
                ...
                var leftHeaderInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(optimumColumns[headerItemIndex]);
                ...
                var rightHeaderInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(optimumColumns[headerItemIndex+1]);

                var lineHeight:Number;
                //Based on what is on left and right of the seperator
                //We need to find out the height of the separator
                var leftParent:ExAdvancedDataGridHeaderInfo = leftHeaderInfo;
                var rightParent:ExAdvancedDataGridHeaderInfo = rightHeaderInfo;
                var padding:int = cachedPaddingBottom+cachedPaddingTop;
				//Duong modify because rightParent = null and give exception
				while(leftParent && rightParent && leftParent!=rightParent && leftParent.parent!=null && rightParent.parent!=null)
//                while(leftParent!=rightParent && leftParent.parent!=null && rightParent.parent!=null)
    ...
    override protected function setupRenderer(itemData:Object,uid:String,insertItems:Boolean = false):void
    {
        ...
        for(var i:int = 0; i < itemCount; ++i)
        {
            ...
            var adgDescription:ExAdvancedDataGridRendererDescription = rendererDescriptionMap[item];
            if (adgDescription && adgDescription.renderer)
            {
     ...
     *  @productversion Flex 3
     */
    override mx_internal function columnItemRendererFactory(c:ExAdvancedDataGridColumn, forHeader:Boolean, itemData:Object):IFactory
    {
        var factory:IFactory;
        if (!forHeader)
        {
			...
			{
				// update for total and sub total
				if(itemData && itemData.hasOwnProperty(SummaryBarConstant.TOTAL) && itemData[SummaryBarConstant.TOTAL] == true)
				{
					factory = (c as ExAdvancedDataGridColumn).totalRenderer;
				}
				else if(itemData && itemData.hasOwnProperty(SummaryBarConstant.SUB_TOTAL)  && itemData[SummaryBarConstant.SUB_TOTAL] == true)
				{
					factory = (c as ExAdvancedDataGridColumn).subTotalRenderer;
				}
			}
        }
        if (!factory)
     ...
     *  @private
     */
    override protected function getPossibleDropPositions(c:ExAdvancedDataGridColumn):Array
    {
        if(columnGrouping && c!=null)
        {
            var headerInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(c);
     ...
     *  @private
     */
    override mx_internal function getHeaderInfo(col:ExAdvancedDataGridColumn):ExAdvancedDataGridHeaderInfo
    {
        if(columnGrouping)
     ...
     *  @private
     */
    override mx_internal function getHeaderInfoAt(colIndex:int):ExAdvancedDataGridHeaderInfo
    {
        if(columnGrouping)
    ...
    override protected function createChildren():void
    {
		...
		// Duong add
		// add footer into datagrid
		if (!footer)
		{
			footer = new ExAdvancedDataGridFooter();
    ...
    override protected function commitProperties():void
    {
        ...
        if (_rootModel is IGroupingCollection2 && IGroupingCollection(_rootModel).grouping)
	...
	{
		var newBgColor:*;
		var data:Object = this.getItemAt(dataIndex);
		if(data && data.hasOwnProperty(SummaryBarConstant.SUMMARY_BAR_KEY))
		{
			newBgColor = this.getRowSummaryBarStyle(data[SummaryBarConstant.SUMMARY_BAR_KEY],"backgroundColor");
		}
		else
		{
			newBgColor= getRowStyle(data,"backgroundColor");
		}
		if(newBgColor)
			color = this.styleManager.getColorName(newBgColor);
     ...
     *  @private
     */
    override protected function isDraggingAllowed(draggedColumn:ExAdvancedDataGridColumn):Boolean
    {
        ...
        if(columnGrouping)
        {
            var parentInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(draggedColumn).parent;
            
            //Parent doesn't allow its children to be draggable
            if(parentInfo && (parentInfo.column as ExAdvancedDataGridColumnGroup).childrenDragEnabled == false)
                return false;
        }
        return true;
    }
    ...
    override protected function columnDraggingMouseUpHandler(event:Event):void
    {
        ...
        var headerInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(movingColumn);
     ...
     *  implements the copy of the ExAdvancedDataGrid data based on its structure.  
     *
    ...
    override public function createItemEditor(colIndex:int, rowIndex:int):void
    {
        ...
        {
            var col:ExAdvancedDataGridColumn = displayableColumns[colIndex];
    ...
    override protected function makeListData(data:Object, uid:String, 
                                             rowNum:int, columnNum:int, column:ExAdvancedDataGridColumn):BaseListData
    {
        var label:String ;
        var advancedDataGridListData:ExAdvancedDataGridListData;
        if(data is ExAdvancedDataGridColumnGroup) 
        {
            return new ExAdvancedDataGridListData((column.headerText != null) ? column.headerText : "", 
                                                data.dataField, -1, uid, this, rowNum);
        }
        else if (!(data is ExAdvancedDataGridColumn))
        { 
            if (groupItemRenderer && isBranch(data) && column.colNum == treeColumnIndex)
            {
                ...
                if (label)
                    advancedDataGridListData = new ExAdvancedDataGridListData(label, column.dataField, 
        ...
        if (!advancedDataGridListData)
            advancedDataGridListData = 
                super.makeListData(data, uid, rowNum,columnNum,column) as ExAdvancedDataGridListData;

        if (iterator && iterator is HierarchicalCollectionViewCursor && columnNum == treeColumnIndex
                        && !(data is ExAdvancedDataGridColumn))
    ...
    {
        if (_rootModel && (_rootModel is IGroupingCollection2 || _rootModel is IGroupingCollection2))
        {
            // group header
                                               ...
                                               trigger:Event = null):void
    {
        if (newIndex >= 0 && oldIndex != newIndex)
        {
            ...
            else
            {
                ...
                var groupColumns:Array = headerInfo.parent == null ? groupedColumns : (headerInfo.parent.column as ExAdvancedDataGridColumnGroup).children;
                ...
                if (newIndex >= 0 && oldIndex != newIndex)
                {
                    ...
                    {
                        var j:int = i + incr;
                        var c:ExAdvancedDataGridColumn = groupColumns[i];
                        ...
                        var cInfo:ExAdvancedDataGridHeaderInfo = groupInfos[i];
     ...
     */
    override public function getFieldSortInfo(column:ExAdvancedDataGridColumn):ExSortInfo
    {
        if (!sortExpertMode && visualSortInfo[column.colNum])
            return visualSortInfo[column.colNum];

         var headerInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(column);
             ...
             && headerInfo.internalLabelFunction != null)
         {
            ...
            for (var i:int = 0; i < n; i++)
            {
                ...
                if( uid &&  collection.sort.fields[i].name == uid)
                    return new ExSortInfo(i + 1, collection.sort.fields[i].descending);
            }
        }
        else
        {
    ...
    override protected function moveIndicators(uid:String, offset:int, absolute:Boolean):void
    {
        ...
        {
            // Functionality in ExAdvancedListBase, so we can't assume that it
    ...
    override mx_internal function clearHighlight(item:IListItemRenderer):void
    {
        if (isCellSelectionMode())
        {
            ...
            var c:ExAdvancedDataGridColumn = columnMap[item.name];
            if (c)
            {
            ...
            if (!cellSelectionData[uid] || !cellSelectionData[uid][columnIndex])
            {
                ...
                else
                {
                    ...
                    addCellSelectionData(uid, columnIndex,
                             new ExAdvancedDataGridBaseSelectionData(data,
     ...
     *  @private
     */
    override mx_internal function getMeasuringRenderer(c:ExAdvancedDataGridColumn, forHeader:Boolean, data:Object):IListItemRenderer
    {
        if (!forHeader)
        {
            var adgDescription:ExAdvancedDataGridRendererDescription;
                               ...
                               cause:Event = null):void
    {
        ...
        else
        {
            ...
            if (dispatchEvent)
            {
                dispatchExAdvancedDataGridEvent(open ? ExAdvancedDataGridEvent.ITEM_OPEN : ExAdvancedDataGridEvent.ITEM_CLOSE,
                                              item,
        ...
        if (animate && rowIndex < rC && rowsToMove > 0 && rowsToMove < 20 && dur!=0)
        {
            ...
            if (renderer is IDropInListItemRenderer)
            {
                ...
                var advancedDataGridListData:ExAdvancedDataGridListData = ExAdvancedDataGridListData(di.listData);
                advancedDataGridListData = ExAdvancedDataGridListData(
            ...
            var c:ExAdvancedDataGridColumn;
            var optimumColumns:Array = getOptimumColumns();
            if (open)
            {
    ...
    mx_internal function onTweenEnd(value:Object):void
    {
        ...
        if (eventAfterTween)
        {
            ...
            dispatchExAdvancedDataGridEvent((isItemOpen(eventAfterTween)
                                           ? ExAdvancedDataGridEvent.ITEM_OPEN
                                           : ExAdvancedDataGridEvent.ITEM_CLOSE),
                                          eventAfterTween,
                                          itemRenderer,
                                          lastUserInteraction);
            lastUserInteraction = null;
	...
	/************************************************
	 * Get item index of item
	 * @param obj Item to get index
	 * @author Thuan 
    ...
    public function expandChildrenOf(item:Object, open:Boolean):void
    {
        ...
        if (isBranch(item))
        {
            dispatchExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_OPENING,
                                          item,   //item
                                          null,   //renderer
                                          null,   //trigger
                                          open,   //opening
    ...
    /**
     *  Initializes an ExAdvancedDataGridListData object that is used by the AdvancedDataGrid item renderer.
     * 
     *  @param item The item to be rendered.
     *  This Object contains the data provider element for the item. 
     * 
     *  @param adgListData The ExAdvancedDataGridListDataItem to use in rendering the item.
     *  
     *  @langversion 3.0
     *  @playerversion Flash 9
     *  @playerversion AIR 1.1
     *  @productversion Flex 3
     */
    protected function initListData(item:Object, adgListData:ExAdvancedDataGridListData):void
    {
        if (item == null)
            return;
     ...
     *  @private
     */
    mx_internal function dispatchExAdvancedDataGridEvent(type:String,
                                                       item:Object,
    ...
    {
        var event:ExAdvancedDataGridEvent;

        // Create expanding event.
        if (type == ExAdvancedDataGridEvent.ITEM_OPENING)
        {
            event = new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_OPENING,
                                              false, true);
        ...
        if (!event) 
            event = new ExAdvancedDataGridEvent(type);
        ...
        if (dataProvider is IHierarchicalCollectionView && iterator)
        {
            ...
            while(!iterator.afterLast)
            {
                ...
                if (isBranch(item) && !isItemOpen(item))
                {
                    ...
                    dispatchExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_OPEN,
                                                  item,
                                                  itemRenderer,
                                                  null);
                }
    ...
    public function collapseAll():void
    {
        if (dataProvider is IHierarchicalCollectionView && iterator)
        {
            ...
            {
                dispatchExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_CLOSE,
                                              item,
                                              visibleData[itemToUID(item)]);
            }
     ...
     *
     */
    mx_internal function getRendererDescription(itemData:Object,c:ExAdvancedDataGridColumn, forDragProxy:Boolean = false):ExAdvancedDataGridRendererDescription
    {
        var adgDescription:ExAdvancedDataGridRendererDescription = new ExAdvancedDataGridRendererDescription();
        var index:int = 0;
        var depth:int = 0;
        if (rendererProviders.length !=0)
        {
        ...
        for (var i:int = 0; i < n; i++)
        {
			IExAdvancedDataGridRendererProvider(rendererProviders[i]).describeRendererForItem(itemData,depth,c,adgDescription);
    ...
    private function createHeaderItems(subHeaderInfos:Array):Number
    {
        var i:int;
        var c:ExAdvancedDataGridColumn;
        var rowData:ExAdvancedDataGridListData;
        var item:IListItemRenderer;
        ...
        for (i = 0; i < n; i++)
        {
            ...
            rowData = ExAdvancedDataGridListData(makeListData(c, uid, -1, c.colNum, c));
    ...
    /**
     *  Applies styles from the ExAdvancedDataGrid control to an item renderer.
    ...
    protected function applyUserStylesForItemRenderer(givenItemRenderer:IListItemRenderer):void
    {
        ...
        var column:ExAdvancedDataGridColumn = columnMap[DisplayObject(itemRenderer).name];
     ...
     *  @private
     */
    private function columnGroupRendererChanged(c:ExAdvancedDataGridColumnGroup):void
    {
        ...
        if (n > 0)
        {
            ...
            for( var i:int = 0; i < n; i++)
            {
                if (c.children[i] is ExAdvancedDataGridColumnGroup)
    ...
    {
        // add items only if the target component is ExAdvancedDataGrid
        /* if (!(event.relatedObject is ExAdvancedDataGrid))
            return; */
    ...
    private function validateGroupedColumns(groupedColumns:Array):Boolean
    {
        ...
        {
            var c:ExAdvancedDataGridColumn = queue.shift();;
            ...
            {
                dict[uid] = c;
                if (c is ExAdvancedDataGridColumnGroup)
                {
                    var cGroup:ExAdvancedDataGridColumnGroup = ExAdvancedDataGridColumnGroup(c);
                    if (cGroup.children)
                    {
    ...
    private function getLeafColumns(groupedColumns:Array):Array
    {
        ...
        {
            if (groupedColumns[i] is ExAdvancedDataGridColumnGroup && groupedColumns[i].children && groupedColumns[i].children.length >0)
            {
     ...
     *  @private
     */
    private function initializeGroupedHeaderInfo(groupedColumns:Array, parent:ExAdvancedDataGridHeaderInfo, depth:int, parentInternalLabelFunction:Function=null):Array
    {
        ...
        for (var i:int = 0; i < n; i++ )
        {
            var headerInfo:ExAdvancedDataGridHeaderInfo = new ExAdvancedDataGridHeaderInfo(groupedColumns[i], 
                                                                                       parent, i, depth) ;
            ...
            if (groupedColumns[i] is ExAdvancedDataGridColumnGroup && groupedColumns[i].children && groupedColumns[i].children.length > 0)
            {
                ...
                if (groupedColumns[i].dataField || groupedColumns[i].labelFunction || parentInternalLabelFunction != null)
                {
                    ...
                    if (parentInternalLabelFunction == null)
                        childInternalLabelFunction = (function(data:Object, c:ExAdvancedDataGridColumn):*
                        { 
                            var parentInfo:ExAdvancedDataGridHeaderInfo  = getHeaderInfo(c).parent;
                            var parentColumn:ExAdvancedDataGridColumnGroup = parentInfo.column as ExAdvancedDataGridColumnGroup;
                            
                            return parentColumn.itemToData(data);
                        });
                    else
                        childInternalLabelFunction = (
                            function(data:Object, c:ExAdvancedDataGridColumn):*
                        { 
                            var parentInfo:ExAdvancedDataGridHeaderInfo  = getHeaderInfo(c).parent;
                            var parentColumn:ExAdvancedDataGridColumnGroup = parentInfo.column as ExAdvancedDataGridColumnGroup;
    ...
    protected function updateVisibleHeaderInfos(headerInfos:Array = null, parentVisible:Boolean = true, actualColNum:int = 0):Object
    {
        ...
        for (i = 0; i < n; i++)
        {
            var headerInfo:ExAdvancedDataGridHeaderInfo = headerInfos[i];
     ...
     *  @private
     */
    protected function selectColumnGroupHeader(headerInfo:ExAdvancedDataGridHeaderInfo):void
    {
     ...
     *  @private
     */
    private function scrollColumnGroupIfNeeded(h1:ExAdvancedDataGridHeaderInfo, h2:ExAdvancedDataGridHeaderInfo):void
    {
    ...
    protected function finishCellKeySelection():void
    {
        ...
        if (bSelectItem && caretIndex - verticalScrollPosition >= 0)
        {
			...
			//Duong modify
			// add code here to solve when moving between cells by keyboard.
			if(mergeCells == null || (mergeCells && mergeCells.length == 0))
			{
		...
		//Duong modify 
		//set focus cell in case cell is losing focus to edit cell	
		if(listItem && listItem is ExUIComponent)
		{
			(listItem as ExUIComponent).setFocus();
		}
    }
                                      ...
                                      transition:Boolean = true):Boolean
    {
            ...
            || (selectionMode == MULTIPLE_CELLS && !ctrlKey && !shiftKey))
        {
            ...
            {
                var curSelectionData:ExAdvancedDataGridBaseSelectionData
                ...
                || (selectionMode == SINGLE_CELL))
            {
                ...
                addCellSelectionData(uid, columnIndex,
                                     new ExAdvancedDataGridBaseSelectionData(item.data,
                                                                           index, columnIndex, false) );
            ...
            if (anchorBookmark)
            {
                ...
                catch (e:ItemPendingError)
                {
                    e.addResponder(new ItemResponder(
                                       ...
                                       new ExAdvancedDataGridBaseSelectionPending(
                                           index,
                                           anchorIndex,
                                           columnIndex,
                                           anchorColumnIndex,
        ...
        else if (ctrlKey && selectionMode == MULTIPLE_CELLS)
        {
            ...
            {
                addCellSelectionData(uid, columnIndex,
                                     new ExAdvancedDataGridBaseSelectionData(
                                         item.data,
                                         index,
                                         columnIndex,
                                         false) );
    ...
    private function cellSelectionPendingResultHandler(data:Object,
                                                       info:ExAdvancedDataGridBaseSelectionPending):void
    {
     ...
     *
     *  @param selectionData An ExAdvancedDataGridBaseSelectionData instance defining the 
     *  information about the selected cell.
     * 
     *  @see kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridBaseSelectionData
     *  
     *  @langversion 3.0
     *  @playerversion Flash 9
     *  @playerversion AIR 1.1
    ...
    protected function addCellSelectionData(uid:String,
                                            columnIndex:int,
                                            selectionData:ExAdvancedDataGridBaseSelectionData):void
    {
	...
	//===============================================================================
	// add cell border width and color
	//chheavhun  2013/12/13
	//================================================================================
	public var arrCellBorder:Array=new Array();
	/******************************************************************
	 *  draw cell border
	 *  @author chheavhun
	 ******************************************************************/
	public function drawCellBorder(columnInd:int,rowInd:int):void
	{
		var r:IListItemRenderer = listItems[rowInd][columnInd];
		
		if (r ==null)
			return;
		
		var rowData:BaseListData = rowMap[r.name];
		var arrCellBorderInfo:Array=new Array();
		var bChangeStyle:Boolean=false;
		
		if (arrCellBorder.length > 0 )
		{
			for (var i:int=0;i<arrCellBorder.length ;i++)
			{
				if (r==arrCellBorder[i][1])
				{
					arrCellBorder[i][5]= this.cellBorderWidth;
					arrCellBorder[i][6]= this.cellBorderColor;
		...
		if (bChangeStyle==false)
		{
			if (this.cellBorderWidth !=0)
			{ 
				cellBorderSprite= new SpriteAsset();
				
				this.selectionLayer.addChild(DisplayObject(cellBorderSprite));
				
				var g:Graphics = Sprite(cellBorderSprite).graphics;
				g.clear();
				
				var pt:Point=Sprite(cellBorderSprite).globalToLocal(r.parent.localToGlobal(new Point(r.x+1,r.y)));
				var w:Number = Math.min(r.width-2, listContent.width - pt.x);
				var h:Number = Math.min(r.height, listContent.height - pt.y);
				
				g.lineStyle(this.cellBorderWidth,this.cellBorderColor, 1);
				g.drawRect(pt.x, pt.y, w, h);
				
				cellBorderSprite.x = x;
				cellBorderSprite.y = y;
				
				g.endFill();		
				
				this.cellBorderUID=rowData.uid;
				this.cellBorderItemRenderer=r;
				this.cellBorderColumnIndex=columnInd;
				
				arrCellBorderInfo.push(this.cellBorderUID);
				arrCellBorderInfo.push(this.cellBorderItemRenderer);
				arrCellBorderInfo.push(this.cellBorderColumnIndex);
				arrCellBorderInfo.push(rowInd);
				arrCellBorderInfo.push(cellBorderSprite);
				arrCellBorderInfo.push(this.cellBorderWidth);
				arrCellBorderInfo.push(this.cellBorderColor);
				
				arrCellBorder.push(arrCellBorderInfo);
	 ...
	 *  @author chheavhun
	 ******************************************************************/
	public function redrawCellBorder():void
	{
		...
		for(var i:int=0; i<arrCellBorder.length; i++)
		{
			tg=getCellItemAt(this.arrCellBorder[i][3],  this.arrCellBorder[i][2]);
			...
			if(tg)
			{
				...
				if(settedCol!=this.arrCellBorder[i][2] || settedRow!=this.arrCellBorder[i][3])
				{
					settedCol=this.arrCellBorder[i][2];
					settedRow=this.arrCellBorder[i][3];
					
				 	this.selectionLayer.addChild(DisplayObject(this.arrCellBorder[i][4]));
					
					tg.visible=true;
 
					var g:Graphics = Sprite(this.arrCellBorder[i][4]).graphics;
					g.clear();
					
					var pt:Point=Sprite(this.arrCellBorder[i][4]).globalToLocal(tg.parent.localToGlobal(new Point(tg.x+1,tg.y-1)));
					var w:Number = Math.min(tg.width-2, listContent.width - pt.x);
					var h:Number = Math.min(tg.height, listContent.height - pt.y);
					
					if (tg.height > this.arrCellBorder[i][1].height)
					{
						 h=h-2;
					}
					else
					...
					g.lineStyle(this.arrCellBorder[i][5],this.arrCellBorder[i][6], 1);
					g.drawRect(pt.x, pt.y, w, h);
					
					this.arrCellBorder[i][4].x = x;
					this.arrCellBorder[i][4].y = y;
 
					g.endFill();
 
				}
				else if(settedCol==this.arrCellBorder[i][2] && settedRow==this.arrCellBorder[i][3])
				{
					tg.visible=false;
				}
			}
	 ...
	 * @author chheavhun
	 ******************************************************************/
	public function removeCellBorder(column:Number,rowInd:Number):void
	{
		var r:IListItemRenderer = listItems[rowInd][column];
		if (r ==null)
			return;
		...
		if (this.arrCellBorder.length !=0)
		{
			for (var i:int=0;i<this.arrCellBorder.length;i++)
			{
				if (column !=this.arrCellBorder[i][2] && r!=this.arrCellBorder[i][1])
				{
					arr.push(this.arrCellBorder[i]);
				}
				else
				{
					var obj:Sprite=this.arrCellBorder[i][4];
					Sprite(obj as Sprite).graphics.clear();
				}
			}
			
			this.arrCellBorder=arr;
	...
	/******************************************************************
	 *  remove all cell border
	 *  @author chheavhun
	 ******************************************************************/
	public function removeCellBorderAll():void
	{
		if (this.arrCellBorder.length !=0)
		{
			for (var i:int=0;i<this.arrCellBorder.length;i++)
	...
	/******************************************************************
	 *  clear all cell border 
	 *  @author chheavhun
	 ******************************************************************/
	public function clearCellBorderAll():void
	{
		if (this.arrCellBorder.length !=0)
		{
			for (var i:int=0;i<this.arrCellBorder.length;i++)
   ...
   override protected function getHeaderItemsLength():int
   {
    ...
    override protected function headerNavigationHandler(event:KeyboardEvent):void
    {
       ...
       else
       {
          ...
          var newSelectedHeaderInfo:ExAdvancedDataGridHeaderInfo;
          var siblings:Array;
          ...
          else if (keyCode == Keyboard.SPACE)
          {
                  ...
                  && columns[selectedHeaderInfo.column.colNum].sortable)
              {
                  ...
                  var advancedDataGridEvent:ExAdvancedDataGridEvent =
                      new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.SORT, false, true);
	...
	/**
	 *  check column selected is combo or not. If it is combo, and keycode = F2, user can open combobox	 
	 */
	private function checkComboKeyDown(event:KeyboardEvent):Boolean
	{
		var col:ExAdvancedDataGridColumn=this.columns[this._selectedColIndex];
		if( col && col.type==ColumnType.COMBOBOX)
		{
			...
			if(col.isOpenningCombo && (event.keyCode==Keyboard.ENTER || event.keyCode==Keyboard.UP || event.keyCode==Keyboard.DOWN || event.keyCode==Keyboard.LEFT || event.keyCode==Keyboard.RIGHT))
			{
				event.preventDefault();
				return true;
			}
    ...
    {
		var _currKeyCode:uint=event.keyCode;
		
		if(event.keyCode == Keyboard.F2)
			isPressedF2 = true;
		
		//Duong modified when using enter with value = nextcell or belowcell
		if (event.keyCode != Keyboard.SPACE && event.keyCode == 13)
		{
			if(strEnterNavigate==Global.STR_ENTER_NAVIGATE_NEXT)
			{
				if(strCellClickAction == Global.CELLSELECT)		//double click
				{
					if(selectCell)
					{
						//update correctly next cell when moving by keyboard
						moveSelectionPosition(event.keyCode,event.shiftKey,event.ctrlKey);
						return;
					}
					else
						event.keyCode = Keyboard.DOWN;			// nextcell will work as belowcell when selectionMode = row
				}
				else if(!selectCell && strCellClickAction == Global.ROWSELECT)
					event.keyCode = Keyboard.DOWN;
				else
				{
					//edit
					if(mergeCells == null) 		//work as tab navigator in edit mode when selectionMode = row or cell
					{
						if(!selectCell)
						{
							event.keyCode = Keyboard.TAB;		
							if(!event.isDefaultPrevented() && findNextItemRenderer(event.shiftKey))
							{
								event.preventDefault();
								return;
							}
					...
					else
					{
						...
						if(!selectCell)
						{
							event.keyCode = 40;		//selectionMode = row
						}
						else
						{
							//selectionMode = cell
			...
			else if(strEnterNavigate==Global.STR_ENTER_NAVIGATE_BELOW)
			{
				if(editedItemPosition && event.keyCode == 13 && _columns[_selectedColIndex].editable == true)
				{
					return;
				}
				else if(editedItemPosition == null &&event.keyCode == 13 && _columns[_selectedColIndex].editable == true)
				{
					findNextEnterItemRenderer(event)
					return;
				}
				if(editedItemPosition && _columns[_selectedColIndex].editable == true && event.target != event.currentTarget)
					return;
				event.keyCode = 40;
			}
		}
...
//		{
//			var listItem:IListItemRenderer = listItems[_selectedRowIndex-verticalScrollPosition][_selectedColIndex-horizontalScrollPosition];
//			if(listItem)
//				selectCellItem(listItem, event.shiftKey, event.ctrlKey, false);
//		}
		if (isCellSelectionMode() && headerIndex == -1 && event.keyCode != Keyboard.ESCAPE)
...
//		_selectedRowIndex = caretIndex;
//		if(isCellSelectionMode())
//			_selectedColIndex = caretColumnIndex;
		
    }

	/**
	 *  moving between cell in case combobox
	 */
    ...
    {
		if(this.eventArr.hasOwnProperty(SAEvent.TEXT_INPUT_KEY_UP))
		{
			//dispatch event textInputKeyUp event to javascript
			var saEvent:SAEvent = new SAEvent(SAEvent.TEXT_INPUT_KEY_UP,true);
			saEvent.strText = itemEditorInstance[_columns[_selectedColIndex].editorDataField].toString();
			saEvent.keyCode = event.keyCode;
			saEvent.columnKey = _columns[_selectedColIndex].dataField;
			saEvent.nRow = _selectedRowIndex; //Add property nRow for Feature #3894 (Keyup event)
			this.dispatchEvent(saEvent);
		}
		
        if (event.keyCode == Keyboard.F2)
        {
			this.isPressedF2 = true;
			if(!(itemEditorInstance is ComboEditor))
			{
				endEdit(ExAdvancedDataGridEventReason.OTHER);
			}
			else
			{
				if(checkComboKeyDown(event))
				{
					var exEvent:ExAdvancedDataGridEvent=new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.COMBO_KEY_DOWN);
					exEvent.keyEvent=event;
					(itemEditorInstance as UIComponent).setFocus();
					itemEditorInstance.dispatchEvent(exEvent);
				}
			}
			setFocus();
			invalidateDisplayList();
        ...
        if (!sortExpertMode)
        {
                    ...
                    && Object(item).hasOwnProperty("mouseEventToHeaderPart") )
            {
                ...
                if (!visualSortInfo[colNum] || visualSortInfo["HEADERPART" + colNum] != headerPart)
                {
                    ...
                    {
                        visualSortInfo[colNum] = new ExSortInfo(1, false, ExSortInfo.PROPOSEDSORT);
                        invalidateRenderer(item);
                    ...
                    else if (headerPart == HEADER_ICON_PART)
                    {
                        ...
                        var sortInfo:ExSortInfo = getFieldSortInfo(columns[colNum]);
                        if (sortInfo)
                        {
                        ...
                        visualSortInfo[colNum] = new ExSortInfo(sequenceNumber, descending,
                                                                ExSortInfo.PROPOSEDSORT);
                        invalidateRenderer(item);
                        visualSortInfo["HEADERPART" + colNum] = headerPart;
                    }
                }
     ...
     *  @private
     */
    override protected function sortHandler(event:ExAdvancedDataGridEvent):void
    {
        if (event.isDefaultPrevented())
            return;
        ...
        if(columnGrouping)
        {
            ...
            var headerInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(columns[columnNumber]);
     ...
     *  @private
     */
    override protected function headerReleaseHandler(event:ExAdvancedDataGridEvent):void
    {
        if (event.isDefaultPrevented())
            return;
        ...
        var adgEvent:ExAdvancedDataGridEvent =
            new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.SORT, false, true);
...
//        if (!collection || !collection.sort || !collection.sort.fields		//Duong comment
...
//        }
        ...
        {
			adgEvent.multiColumnSort = true;		//Duong add here
            dispatchEvent(adgEvent);
        }
    ...
    override protected function mouseWheelHandler(event:MouseEvent):void
    {
		...
		{
			// Duong add
			//create delta = 1/-1 when using mouseWheel
			event.delta=event.delta/Math.abs(event.delta)*mouseWheelPageSize;	
     ...
     * @private
     */
    mx_internal function expandItemHandler(event:ExAdvancedDataGridEvent):void
    {
        if (event.isDefaultPrevented())
            return;

        if (event.type == ExAdvancedDataGridEvent.ITEM_OPENING)
        {
    ...
    protected function cellNavigationHandler(event:KeyboardEvent):void
    {
		...
		var cellMergeInfo:MergeCellInfo;
		var ownerVisibleMergeItem:Object;
		var newCaretIndex:int;		// variable is used to update vertical scroll bar in case datagrid has merged
		var rowIndex:int;
        ...
        switch (keyCode)
        {
            case Keyboard.UP:
            {
                ...
                else if (caretIndex > 0)
                {
					...
					//Duong add to update rowIndex of merged cell
					if(mergeCells == null)
						caretIndex --;
					else
					{
						ownerVisibleMergeItem = getOwnerMergeInfoAt(caretIndex,caretColumnIndex,Keyboard.UP);
						if(ownerVisibleMergeItem)
						{
							caretIndex = ownerVisibleMergeItem["ownerRowIndex"];
							newCaretIndex = caretIndex - ownerVisibleMergeItem["numMerge"];
						}
					}
                    bUpdateVerticalScrollPosition = true;
                    bSelectItem = true;
            ...
            case Keyboard.DOWN:
            {
                ...
                {
					//Duong modify 
					// update rowIndex in case grid has merge
					if(mergeCells)
					{
						ownerVisibleMergeItem = getOwnerMergeInfoAt(caretIndex,caretColumnIndex,Keyboard.DOWN);
						if(ownerVisibleMergeItem)
						{
							caretIndex = ownerVisibleMergeItem["ownerRowIndex"];
							newCaretIndex = caretIndex + ownerVisibleMergeItem["numMerge"];
							if((caretIndex == collection.length) && partialRow)
							{
								caretIndex = newCaretIndex = collection.length - 1;
...
//                    if (newData && isDataEditable(newData) && displayableColumns[caretColumnIndex].editable)		//Duong comment here caretColumnIndex is greater than displayableColumns.length => caretIndex according to column 
					if (newData && isDataEditable(newData) && columns[caretColumnIndex].visible && columns[caretColumnIndex].editable)
                    {
                        // Open editor
                        var advancedDataGridEvent:ExAdvancedDataGridEvent
                                = new ExAdvancedDataGridEvent(
                                        ExAdvancedDataGridEvent.ITEM_EDIT_BEGINNING,
                                                        false, true);
        ...
        if (bUpdateVerticalScrollPosition)
        {
			...
			if (newCaretIndex < lockedRowCount)
			{
				newVerticalScrollPosition = 0;
			}
			else if (newCaretIndex < verticalScrollPosition + lockedRowCount)
			{
				newVerticalScrollPosition = newCaretIndex - lockedRowCount;
			}
			else if (newCaretIndex >= verticalScrollPosition + rowCount - partialRow)
			{
				newVerticalScrollPosition = Math.min(maxVerticalScrollPosition,
					newCaretIndex - rowCount + partialRow + 1);
			}
		...
		//Duong modify to save column index and row index when moving by keyboard in case cell mode
		_selectedColIndex = getColumnIndexByVisibleIndex(caretColumnIndex);
		_selectedRowIndex = caretIndex;
	...
	*/
	...
	/*************************************************************
	 * override dispatchEvent to dispatch SAEvent
	 * ***********************************************************/
	override public function dispatchEvent(event:Event):Boolean
	{
		if (event is SAEvent)
		{
			if (eventArr[event.type] != null)
				ExternalInterface.call(eventArr[event.type], (event as SAEvent).eventResult);
		}
		return super.dispatchEvent(event);
	}
	
	/******************************************************************
	 * datagrid item edit begginning handler
	 ******************************************************************/
	private function dg_itemEditBeginningHandler(event:ExAdvancedDataGridEvent):void
	{
		if(event.columnIndex == -1)
			return;
		if(!(this.columns[event.columnIndex] as ExAdvancedDataGridColumn).showEditor)
		{
			event.preventDefault();
			event.stopImmediatePropagation();
			return;
		}
		if((this.columns[event.columnIndex] as ExAdvancedDataGridColumn).type == ColumnType.CRUD)
		{
			event.preventDefault();
			event.stopImmediatePropagation();
			return;
		...
		if(this.strCellClickAction==Global.CELLSELECT)
		{
			this.selectedItemPos={columnIndex: event.columnIndex, rowIndex: event.rowIndex};
			event.preventDefault();
			event.stopImmediatePropagation();
			return;
		}
		var isEdit:Boolean = activationFunction(event.rowIndex,event.columnIndex);
		if(!isEdit)
		{
			event.preventDefault();
			event.stopImmediatePropagation();
	...
	/******************************************************************
	 *  datagrid item edit end handler
	 ******************************************************************/
	private function dg_itemEditEndHandler(event:ExAdvancedDataGridEvent):void
	{
		 this.validateNow();
	}
	 ...
	 *  get header sizing
	 ******************************************************************/
	public function get strHDSizing():String
	{
		return _strHDSizing;
	}
	 ...
	 * set header sizing
	 ******************************************************************/
	public function set strHDSizing(value:String):void
	{
		this._strHDSizing=value;
		if(value=="none")
		{
	 ...
	 ******************************************************************/
	public function removeSelectedRadio():void
	{
		for each (var col:ExAdvancedDataGridColumn in this.columns)
		{
			col.selectedRadioItem=null;
		}
	}
	
	/******************************************************************
	 * get back up item index
	 ******************************************************************/
	public function getBackupItemIndex(item:Object):int
	{
		if(this.bFilterDataIndex)
		{
			var i:int = 0;
			do
			{
				if (this.dataProvider[i] == item)
					break;
				i++;
			}
		...
		return this._bkDP.getItemIndex(item);
	}
	
	/******************************************************************
	 *  get back up item
	 ******************************************************************/
	public function getBackupItem(index:int):Object
	{
		if(this.bFilterDataIndex)
		{
			...
			do
			{
				if (this._bkDP[i] === item)
					break;
				i++;
			}
			while (i<this._bkDP.length);
			return this._bkDP.getItemAt(i);
		}
		return this._bkDP.getItemAt(index);
	}	
	
	/******************************************************************
	 *  set header click action
	 ******************************************************************/
	public function set strHDClickAction(value:String):void
	{
		_strHDClickAction=value;
		switch (value)
		{
			case "select":
	...
	/******************************************************************
	 * get header click action
	 ******************************************************************/
	public function get strHDClickAction():String
	{
		return _strHDClickAction;
	}
	
	/******************************************************************
	 *  datagrid item click handler
	 ******************************************************************/
	private function dg_itemClickHandler(event:ListEvent):void
	{
		var col:ExAdvancedDataGridColumn=this.columns[event.columnIndex];
		
		if (strCellClickAction == Global.EDIT)
		{
			if (!this.isEditable)
			{
		...
		else if (strCellClickAction == Global.ROWSELECT)
		{
			if (this.isEditable)
			{
		...
		else if (strCellClickAction == Global.CELLSELECT && !this.bItemEditBegin)
		{				
			if (!isSelectCalendar)
			{					
				if (this.isEditable)
				...
				if (col.type == ColumnType.CHECKBOX || col.type == ColumnType.COMBOBOX)
					return;
				this.selectedItemPos={columnIndex: event.columnIndex, rowIndex: event.rowIndex};
			}
			else
	...
	/******************************************************************
	 *  datagrid double click handler
	 ******************************************************************/
	private function dg_doubleClicHandler(event:MouseEvent):void
	{
		if (strCellClickAction == Global.CELLSELECT)
		{			
			if (this.selectedItemPos != null)
			{			
				if(this.selectCell)
				{
				...
				if ((this.columns[this.selectedItemPos.columnIndex] as ExAdvancedDataGridColumn).editable && (this.columns[this.selectedItemPos.columnIndex] as ExAdvancedDataGridColumn).cellActivation== Global.ACTIVATE_EDIT)
				{						
					if (!this.isEditable)
					{
						this.isEditable = true;
					...
					editedItemPosition=selectedItemPos;						
				}					
			}
			this.selectedItemPos=null;
			bItemEditBegin = false;
		} 
	}
	
	/******************************************************************
	 *  click calendar handler
	 ******************************************************************/
	private function clickCalendarHanlder(event:Event):void
	{
		if (strCellClickAction == Global.CELLSELECT || strCellClickAction == Global.EDIT)
		{
			if (!this.isEditable)
			{
				this.isEditable = true;
	...
	/******************************************************************
	 *  set row summary bar style
	 ******************************************************************/
	public function setRowSummaryBarStyle(strSummaryBarKey:String,styleName:String,value:Object):void
	{
		var valObj:Object;
		valObj=this._rowStyleDic[strSummaryBarKey];
		if (valObj == null)
		{
			valObj=new Object();
			valObj[styleName]=value;				
		}
		else
		{
			valObj[styleName]=value;
		}
		this._rowStyleDic[strSummaryBarKey]=valObj;
	}
	
	/******************************************************************
	 *  get row summary bar style
	 ******************************************************************/
	public function getRowSummaryBarStyle(strSummaryBarKey:String,styleName:String):Object
	{
		if(_rowStyleDic[strSummaryBarKey])
			return _rowStyleDic[strSummaryBarKey][styleName];	
		return null;
	}
	 ...
	 *  set row style
	 ******************************************************************/
	public function setRowStyle(nRow:int,styleName:String,value:Object):void
	{
		if(this._bkDP.length > 0 && nRow < this._bkDP.length)
		{
			var rowObj:Object = this.getItemAt(nRow);
			if(rowObj == null)
				return;
			var keyObj:String=rowObj[Global.ACTSONE_INTERNAL];
			var valObj:Object=_rowStyleDic[keyObj];
			if (valObj == null)
			{
				valObj=new Object();
				valObj[styleName]=value;				
	 ...
	 *  get row style
	 ******************************************************************/
	public function getRowStyle(dataObj:Object,styleName:String):*
	{
		if(dataObj == null)
			return null;
		var keyObj:String=dataObj[Global.ACTSONE_INTERNAL];
		if(_rowStyleDic[keyObj])
			return _rowStyleDic[keyObj][styleName];	
		return null;
	}
	 ...
	 *  activation function
	 ******************************************************************/
	public function activationFunction(nRow:int, nCol:int):Boolean
	{
		if((this.hasTotal || this.hasSubTotal) && this.dataProvider.length > 0)
		{
			var check : Object = this.getItemAt(nRow);
			if(check[SummaryBarConstant.SUB_TOTAL] == true || check[SummaryBarConstant.TOTAL] == true)
				return false;
		}
		
		if(nCol >=0  &&  (this.columns[nCol] as ExAdvancedDataGridColumn).type == ColumnType.CRUD)
			return false;
		
		var _selectedItem:Object;
		if(this.selectCell)
		{
			_selectedItem = getItemAt(nRow);
		...
		if(_selectedItem)
		{
			var keyObj:String=_selectedItem[Global.ACTSONE_INTERNAL]+","+nCol;
			var activeObj:Object=this._cellDict[keyObj];
			if (activeObj != null && activeObj.activation!=null)
			{
				if (activeObj.activation == Global.ACTIVATE_EDIT)
				{
					bItemEditBegin=true;
					return true;
				}
			...
			if (nCol >= 0 && 
				(this.columns[nCol] as ExAdvancedDataGridColumn).cellActivation== Global.ACTIVATE_EDIT)
			{
				bItemEditBegin=true;
				return true;
			}
	 ...
	 * 
	 ******************************************************************/
	public function setCellProperty(dataField:String, rowIndex:int, value:Object , propertyName:String):void
	{
		if(this._bkDP && this._bkDP.length > 0 && rowIndex < this._bkDP.length)
		{
			var rowObj:Object = this.getItemAt(rowIndex);
			var keyObj:String;
			if(propertyName == 'activation')
				keyObj=rowObj[Global.ACTSONE_INTERNAL]+"," + this.dataFieldIndex[dataField];
			else
				keyObj=rowObj[Global.ACTSONE_INTERNAL]+","+ dataField;
			var valObj:Object=this._cellDict[keyObj];
			if (valObj == null)
			{
				valObj=new Object();
			}
			valObj[propertyName]=value;
			this._cellDict[keyObj]=valObj;
			this.invalidateList();
		}
	...
	/*************************************************************
	 * get property of specified cell
	 * @param col index of column. 
	 * 		If col > 0 then it will get dataField of that visible column
	 * 		If col == 0 then dataField will be assigned in last parameter
	 * @param row index of row
	 * @param propertyName the name of property need to be got.
	 * @param uid in each row. By default, it is "". In case it is not null or "", this value is used to get keyObject
	 * @param dataField. By default, it is "". In case it is not null or "", this value is used to get keyObject
	 * @return string data of that property
	 * @author Duong Pham
	 * ***********************************************************/
	public function getCellProperty(propertyName:String,uid:String,dataField:String):String
	{
		if(this._bkDP == null || this._bkDP.length == 0)
			return null;
		var rowObj:Object;
		var keyObj:String;
		...
		var colIndex:int = this.dataFieldIndex[dataField];
		if(propertyName == 'activation')
			keyObj = uid +","+colIndex;
		else
			keyObj = uid +","+ dataField;
		var valObj:Object=this._cellDict[keyObj];			
		if (valObj != null)
		{
			return valObj[propertyName];
		}		
		return null;
	}
	
	/*************************************************************
	 * set style of summary bar from a specified cell
	 * @param strSummaryBarKey key of summary bar
	 * @param dataField belong to column
	 * @param styleName the name of style need to be got.
	 * @param value kind of style data
	 * @author Duong Pham
	 * ***********************************************************/
	public function setCellSummaryBarStyle(strSummaryBarKey:String,dataField:String,styleName:String,value:Object):void
	{
		var valObj:Object;
		var keyObj:String = strSummaryBarKey + "," + dataField;
		valObj=this._cellDict[keyObj];
		if (valObj == null)
		{
			valObj=new Object();
			valObj[styleName]=value;				
	...
	/*************************************************************
	 * get style of summary bar from a specified cell
	 * @param strSummaryBarKey key of summary bar
	 * @param dataField belong to column
	 * @param styleName the name of style need to be got.
	 * @return value of kind style
	 * @author Duong Pham
	 * ***********************************************************/
	public function getCellSummaryBarStyle(strSummaryBarKey:String,dataField:String,styleName:String):Object
	{
		var keyObj:String = strSummaryBarKey + "," + dataField;
		if(_cellDict[keyObj])
			return _cellDict[keyObj][styleName];	
		return null;
	}
	
	/*************************************************************
	 * set checked in checkbox column when double clicked in header
	 * @param col column is checkbox type
	 * @param bValue 
	 * 		true : checked
	 * 		false: unchecked		
	 * @author Duong Pham
	 * ***********************************************************/
	public function setHeaderCheckBoxValue(col:ExAdvancedDataGridColumn,bValue:Boolean):void
	{
		col.isSelectedCheckboxAll=bValue;
		...
		if(crudMode)
		{
			...
			{								
				...
				if(col.bChangeCellEvent)
				{
					strNewValue = bValue ? "1" : "0";
					if(this.eventArr.hasOwnProperty(SAEvent.ON_CELL_CHANGE))
					{
						if(item[col.dataField].toString() != strNewValue)
						{
							changeEvent= new SAEvent(SAEvent.ON_CELL_CHANGE,true);
							changeEvent.columnKey = col.dataField;
							changeEvent.nRow = i;
							changeEvent.strOldValue = item[col.dataField];										
							changeEvent.strNewValue = strNewValue;	
							dispatchEvent(changeEvent);
						}
					}
				}
				item[col.dataField]=bValue ? "1" : "0";
				//upadte array selected check box to verify when all check box are checked
				this.addRemvoveSelectedCheckBox(col, bValue, item);
				
				if(item[crudColumnKey]!=strInsertRowText)
				{
					item[crudColumnKey]=strUpdateRowText;
					item[crudColumnKey + Global.CRUD_KEY]=Global.CRUD_UPDATE;
				}
			}
		}
		else
	...
	/******************************************************************************************
	 * update list checkbox is selected or not
	 * @author Duong Pham
	 ******************************************************************************************/
	public function addRemvoveSelectedCheckBox(col:ExAdvancedDataGridColumn, selected:Boolean, item:Object):void
	{
		if (selected)
		{
			if (!col.arrSelectedCheckbox.contains(item))
	...
	/*************************************************************
	 * get horizontal position in pixel to dispatch event when
	 * moving horizontal scroll
	 * @author Duong Pham
	 * ***********************************************************/
	public function getHorizontalPostionInPixels():Number
	{
		if (this.horizontalScrollBar != null)
		{
			var scrollThumb:Object=this.horizontalScrollBar.scrollThumb;
			return scrollThumb.y - 16;
		}
		return 0;
	}
	
	/*************************************************************
	 * get horizontal track in pixel to dispatch event when
	 * moving horizontal scroll
	 * @author Duong Pham
	 * ***********************************************************/
	public function getHorizontalTrackInPixels():Number
	{
		if (this.horizontalScrollBar != null)
		{
			var scrollTrack:Object=this.horizontalScrollBar.scrollTrack;
			return scrollTrack.height;
		}
		return 0;
	}
	 ...
	 * @param searchText condition to search
	 * @param direction 'down'  or 'up'
	 * @param position index of row to start search
	 * @param dataField String column Key of column in case user wants to search a specified column. Default is ""
	 * @param caseSensitive boolean
	 * 	 caseSensitive = true  the result will match correctly the search condition which distinguish upper case  and lower case.
	 *   caseSensitive = false the result will match search condition which does not distingush uper case or lower case.
	 * @return Object store rowIndex and column of cell
	 * @author Duong Pham
	 * ***********************************************************/
	public function search(searchText:String, direction:String="down", position:int=0, dataField:String="", caseSensitive:Boolean=false):Object
	{
		...
		var col:ExAdvancedDataGridColumn;
		var end:int = this.dataProvider.length;
		if(position >= end)
			return objResult;
		...
		{				
			while (index < this.dataProvider.length)
			{
				if(dataField != "")
				{
					itemName=this.dataProvider[index][dataField].toString();
					if(caseSensitive)						
					{
						if(itemName.indexOf(searchText) >= 0)							
						{
							objResult = new Object();
							objResult["rowIndex"] = index;
							objResult["colIndex"] = this.dataFieldIndex[dataField];
							isStop = true;
							break;
						}
					}
					...
					{
						if(itemName.toLowerCase().indexOf(searchText.toLowerCase()) >= 0)
						{
							objResult = new Object();
							objResult["rowIndex"] = index;
							objResult["colIndex"] = this.dataFieldIndex[dataField];
				...
				else
				{
					...
					{
						itemName=this.dataProvider[index][col.dataField].toString();
						if(caseSensitive)						
						{
							if(itemName.indexOf(searchText) >= 0)
							{
								objResult = new Object();
								objResult["rowIndex"] = index;
								objResult["colIndex"] = this.dataFieldIndex[col.dataField];
								isStop = true;
								break;
							}
						}
						...
						{
							if(itemName.toLowerCase().search(searchText.toLowerCase()) >= 0)
							{
								objResult = new Object();
								objResult["rowIndex"] = index;
								objResult["colIndex"] = this.dataFieldIndex[col.dataField];
	...
	public function getLength():int
	{
		...
		if (this.isTree)
		{
			len = (((this.dataProvider as HierarchicalCollectionView).source as ExIHierarchicalData).source as ArrayCollection).length;	
		}
		else
		{
	...
	/*************************************************************
	 * end edit a edited cell
	 * @param reason kind of reason to end edit that cell
	 * @author Duong Pham
	 * ***********************************************************/
	public function endEditCell(reason:String):Boolean
	{
		return this.endEdit(reason);
	}
	
	/*************************************************************
	 * get cell item at specified position
	 * @param rowIndex index of row
	 * @param columnIndex index of column
	 * @author Duong Pham
	 * ***********************************************************/
	public function getCellItemAt(rowIndex:int,columnIndex:int):IListItemRenderer
	{
		rowIndex-=this.verticalScrollPosition;
		if (!(rendererProviders.length > 0 && horizontalScrollPolicy != ScrollPolicy.OFF || columnGrouping))
			columnIndex -=this.horizontalScrollPosition;
		if(rowIndex<0 || columnIndex < 0 || listItems==null || listItems.length==0 || rowIndex > this.listItems.length-1 || columnIndex > this.listItems[rowIndex].length-1)
			return null;
		return IListItemRenderer(this.listItems[rowIndex][columnIndex]);
	}
	
	/*************************************************************
	 * when selection mode is cell, the selected (specified) cell is draw background color.
	 * @param colIndex index of column
	 * @param rowIndex index of row 
	 * @author Duong Pham
	 * ***********************************************************/
	public function setSelectCell(colIndex:int, rowIndex:int):void
	{
		var item:IListItemRenderer = getCellItemAt(rowIndex,colIndex);
		if(item)
	 ...
	 * apply style for row
	 * @param data row data
	 * @param column column need to be applied style
	 * @author Duong Pham
	 * ***********************************************************/
	private function rowStyleFunction(data:Object, column:ExAdvancedDataGridColumn):Object
	{
		if(data === null || column == null)
			return null;
		var rowStyleObj:Object;
		if(this._rowStyleDic)
		{
			if(data.hasOwnProperty(SummaryBarConstant.SUMMARY_BAR_KEY))
			{
				rowStyleObj = _rowStyleDic[data[SummaryBarConstant.SUMMARY_BAR_KEY]];
			}
			else
			{
				var keyObj:String=data[Global.ACTSONE_INTERNAL];
				rowStyleObj = _rowStyleDic[keyObj];
			}
		}
		return rowStyleObj;
	}
		...
		else
		{
			...
			if(excelExportInfo.bHeaderOrdering)
			{
				for(j=0;j<_columns.length;j++)
				{
					...
					{
						if(_columns[j].dataField==colArr[i])
						{
							exportedColumns.push(_columns[j]);
							break;
						}
					}
				}
		...
		for(var i:int=0;i<dataProvider.length;i++)
		{
			for(j=0;j<exportedColumns.length;j++)
			{
				if(exportedColumns[j].export)
				{
					...
					{
						s ="";
//						if(dataProvider[i][SummaryBarConstant.TOTAL] != null || dataProvider[i][SummaryBarConstant.SUB_TOTAL] != null)
//						{
							if((dataProvider[i].hasOwnProperty(SummaryBarConstant.TOTAL) || dataProvider[i].hasOwnProperty(SummaryBarConstant.SUB_TOTAL))
								&& exportedColumns[j].dataField == dataProvider[i][SummaryBarConstant.SUMMARY_MERGE_COLUMN])
							{
								dataProvider[i][exportedColumns[j].dataField] = this.lstSummaryBar[dataProvider[i][SummaryBarConstant.SUMMARY_BAR_KEY]].strText;
							}
							else
							{
//								columnArr=this.lstSummaryBar[dataProvider[i][SummaryBarConstant.SUMMARY_BAR_KEY]].strColumnList.split(",");
								columnArr=exportedColumns;
								tmp = "";
								for(var c:int=0; c<columnArr.length; c++)
								{
									if(columnArr[c] == exportedColumns[j].dataField)
									{
										tmp =  exportedColumns[j].itemToLabel(dataProvider[i]);
										break;
									}
								}
							}
//						}
						if(dataProvider[i][exportedColumns[j].dataField] != null)
							s =  exportedColumns[j].itemToLabel(dataProvider[i]);							
						
						s = '"'+ this.replaceCellValueWithAsterisk(exportedColumns[j],s,"*")+ '",';							
						sData += s;
					}
					else
					{
...
//						}
						if(dataProvider[i][exportedColumns[j].dataField] != null)
							s =  dataProvider[i][exportedColumns[j].dataField].toString();							
						s = '"'+ this.replaceCellValueWithAsterisk(exportedColumns[j],s,"*")+ '",';							
						sData += s;
					}
				}	
	...
	/******************************************************************
	 *  replace cell value with asterisk
	 * 
	 ******************************************************************/
	public function replaceCellValueWithAsterisk(col:ExAdvancedDataGridColumn,sCell:String,replaceChar:String):String
	{	
		if(col.replacedStartIndex>=0 && col.replacedLength > 0)
		{
			var newSCell:String = "";
			for(var i:int=0; i < sCell.length; i++)
			{
				if(i>= col.replacedStartIndex && i < col.replacedStartIndex + col.replacedLength)
					newSCell += replaceChar;
				else
					newSCell += sCell.charAt(i);
			}    
			sCell = newSCell;
		}
		return sCell;
	...
	public function getExportedColumns():Array
	{
		...
		else
		{
			if(excelExportInfo.strColumnKeyList==null||StringUtil.trim(excelExportInfo.strColumnKeyList).length==0)
			{
				...
				{
					if (_columns[k].export == true)
					{
						exportedColumns.push(_columns[k]);
					}
				}
			}
			else
			{
				...
				if(excelExportInfo.bHeaderOrdering)
				{
					for(j=0;j<_columns.length;j++)
					{
						for(i=0;i<colArr.length;i++)
						{
							if(_columns[j].dataField==colArr[i] && _columns[j].export == true)
							{
								exportedColumns.push(_columns[j]);
								break;
							}
	...
	public function convertDGToHTMLTable():String 
	{
		...
		exportUltis = new ExportUtils(this);
		...
		var headerDepth:int = this.headerRowInfo.length;
		...
		if (this.isTree)
		{
			acData = (((this.dataProvider as HierarchicalCollectionView).source as ExIHierarchicalData).source as ArrayCollection);	
		}
		else
		{
			if (this.dataProvider is ArrayCollection)
			{
				acData = this.dataProvider as ArrayCollection;
			}
			else if (this.dataProvider is ListCollectionView)
			{
				acData = this.dataProvider as ListCollectionView;
			}
		}
	 ...
	 * 
	 ******************************************************************/
	public function importExcelData(sData:String,
									sColumnList:String="",
									importSeparator:String =",",
									ignoreHeader:Boolean=false,
									ignorebBlankRow:Boolean=true,
									trimBottom:Boolean=true,
									dateImportFormat:String=""):void
	{
		...
		var csv:CSV = new CSV();
		csv.data = sData;
		csv.embededHeader = ignoreHeader;
		csv.filterEmptyRow = ignorebBlankRow;
		csv.decode();
		
		sColumnList = StringUtil.trim(sColumnList);
		var headerArr:Array = [];
		
		if(sColumnList.length==0)
		{
			headerArr = columns;
			//Thuan added on 2012 November 05:
			if (!csv.headerHasValues)
				for (var k:int = 0; k < columns.length; k++)
					csv.header.push(columns[k].dataField);
			//===========================================================
		}
		else
		{
			//Thuan added on 2012 November 05:
			if (!csv.headerHasValues)
				csv.header = sColumnList.split(importSeparator);
			//===========================================================
			var dataFieldArr:Array = sColumnList.split(importSeparator);
			for(var i:int=0;i<dataFieldArr.length;i++)
			{					
				var sDF:String = StringUtil.trim(dataFieldArr[i]);
				for(var j:int = 0;j<columns.length;j++)
				{					
					if(columns[j].dataField == sDF)
					{
						headerArr.push(columns[j]);
						break;
					}
				}
			}			
		...
		{
			var colArr:Array = csv.data[i];
			
			if(!ignorebBlankRow && 
				trimBottom&&colArr.length==1&&StringUtil.trim(colArr[0]).length==0)
				continue;
			
			var item:Object = {};
			//var n:int = Math.min(headerArr.length, colArr.length);
			for (j = 0; j < csv.header.length; j++)
			{	
				var col:ExAdvancedDataGridColumn=getContainColumn(csv.header[j], headerArr);
				if(col==null || !col.importEnable)
					continue;
				
				var s:String = StringUtil.trim((colArr[j] as String));
				...
				//Thuan updated on 2012 November 02:
//				if((col.dataType != undefined) && col.dataType.toUpperCase()=="NUMBER")					
//					s = s.replace( /,/g,"");
				
				if(col.type != "" && col.type != null && col.type.toUpperCase()==ColumnType.NUMBER)					
					s = s.replace( /,/g,"");
				
				if((col as ExAdvancedDataGridColumn).type==ColumnType.DATE && dateImportFormat!="")
				{
					s=DateField.dateToString(DateField.stringToDate(s,dateImportFormat),(col as ExAdvancedDataGridColumn).dateInputFormatString);
				}
				item[col.dataField] = s;
			}    		 	
			dataArr.push(item);  
		}
		...
		if(dataProvider && dataProvider.length > 0)
		{
			...
			this._bkDP = new ArrayCollection([]);
			this.crudProvider=new ArrayCollection([]);
		}
		this.dataProvider = new ArrayCollection(dataArr);
		this._bkDP = new ArrayCollection(dataProvider.toArray());
		this.crudProvider=new ArrayCollection(ObjectUtil.copy(dataArr) as Array);
		//update invisible index order to be used in setRowHide and undoRowHide
		if(this.invisibleIndexOrder)
			this.invisibleIndexOrder = null;
		
	 	setTimeout(dispatchDataCompleted, 500);
		
		headerArr = [];	   	
		CursorManager.removeBusyCursor();
		//dispatch event to update external scroll when data is imported by excel
		this.dispatchEvent(new SAEvent(SAEvent.UPDATE_EXTERNAL_SCROLL));
	}
	
	/*************************************************************
	 * dispatch load data complete event 
	 * ***********************************************************/
	public function dispatchDataCompleted():void
	{
		if(this.eventArr.hasOwnProperty(SAEvent.LOAD_DATA_COMPLETED))
		{
			this.dispatchEvent(new SAEvent(SAEvent.LOAD_DATA_COMPLETED));
		}
		if(this.eventArr.hasOwnProperty(SAEvent.ON_ROW_VISIBLE))
		{
			var saEvent:SAEvent;
			for (var i:int=0; i < this.rowCount; i++)
			{
				if (i < this.getLength())
				{
					saEvent=new SAEvent(SAEvent.ON_ROW_VISIBLE);
					saEvent.nRow=i;
				}
			}
			saEvent.totalRow=this.dataProvider.length;
			this.dispatchEvent(saEvent);
		}
	}
	
	private function getContainColumn(dataField:String,list:Array):ExAdvancedDataGridColumn
	{
		for each(var item:ExAdvancedDataGridColumn in list)
		{ 
			if(dataField == item.dataField ||dataField == item.headerText)
				return item;
		}
		return null;
	}
	...
	/*************************************************************
	 * Verify cell is highlighted or not
	 * @author Duong Pham
	 * ***********************************************************/
	public function isCellHighlighted(data:Object, columnIndex:int):Boolean
	{
		if (data == null)
			return false;
		...
		var isSelected:Boolean = highlightUID && cellSelectionData[highlightUID] && cellSelectionData[highlightUID][columnIndex.toString()];
		
		if(data is String && data == highlightUID && !isSelected && cellSelectionData[highlightUID][columnIndex.toString()] != undefined)
			return true;
		
		var _uid:String = data["mx_internal_uid"];
		if((_uid == highlightUID && columnIndex == highlightColumnIndex) && !isSelected)
			return true;
		return false;
	}
	
	/*************************************************************
	 * Verify cell is selected or not
	 * @author Duong Pham
	 * ***********************************************************/
	public function isCellSelected(data:Object, columnIndex:int):Boolean
	{
		if (data == null)
			return false;
		
		if (data is String && cellSelectionIndicators[data] != undefined && cellSelectionIndicators[data][columnIndex] != undefined)
			return true;
		
		if(cellSelectionIndicators[data["mx_internal_uid"]] != undefined && cellSelectionIndicators[data["mx_internal_uid"]][columnIndex] != undefined)
			return true;
	...
	public function setAccessReader(strColumnKey:String, strAccReader:String):void
	{
		try
		{
			//trace("setAccessReaderOrigin = " + strAccReader);
			(this.columns[this.dataFieldIndex[strColumnKey]] as ExAdvancedDataGridColumn).strAccessReaderOrigin = strAccReader;
		
			var result:String = "";
			var column:ExAdvancedDataGridColumn = this.columns[this.dataFieldIndex[strColumnKey]]; 
			
			//parse strAccessReader
			//"Headertext is %headertex%. Columntype is %columntype%. Control is %controlname%. Value is %value%";
			strAccReader = strAccReader.replace(Global.ACCESS_READER_HEADERTEXT, column.headerText);
			strAccReader = strAccReader.replace(Global.ACCESS_READER_COLUMNTYPE, column.type);
			(this.columns[this.dataFieldIndex[strColumnKey]] as ExAdvancedDataGridColumn).strAccessReader = strAccReader;
			//trace("setAccessReader = " + strAccReader);
		}
		catch(error:Error)
		{
			err.throwMsgError(error.message, "setAccessReader");
		}
	}
	 ...
	 * @author Thuan
	 * ***********************************************************/
	public function setAccessReaderHeader(strColumnKey:String, strAccReader:String):void
	{
		try
		{
 
			//trace("setAccessReaderOrigin = " + strAccReader);
		 	(this.columns[this.dataFieldIndex[strColumnKey]] as ExAdvancedDataGridColumn).strAccessReaderHeaderOrigin = strAccReader;
			//
			var result:String = "";
			var column:ExAdvancedDataGridColumn = this.columns[this.dataFieldIndex[strColumnKey]]; 
			...
			//parse strAccessReader
			strAccReader = strAccReader.replace(Global.ACCESS_READER_COLUMNTYPE, column.type);
			(this.columns[this.dataFieldIndex[strColumnKey]] as ExAdvancedDataGridColumn).strAccessReaderHeader = strAccReader;
			//trace("setAccessReader = " + strAccReader);
		}
		catch(error:Error)
		{
			err.throwMsgError(error.message, "setAccessReaderHeader");
		}
	}
 
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	// implement merge row feature
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	/*************************************************************
	 * draw merge cell
	 * @author Duong Pham
	...
	private var mergedRowNum:Array;
	private var mergedCols:Array;
	/*************************************************************
	 * get all cells are merged into MergeCells array
	 * @author Duong Pham
	 * ***********************************************************/
	public function getGroupMergeInfo():void
	{
		if(columns==null || columns.length==0 || this.dataProvider==null || this.dataProvider.length==0)
			return;
		
		mergeCells=new Array();
		//get column is merged
		mergedCols = new Array();
		for (var ii:int=0; ii<_columns.length; ii++)
		{
			var tmpCol:ExAdvancedDataGridColumn=ExAdvancedDataGridColumn(_columns[ii]);
			if(tmpCol.merge)
				mergedCols.push(tmpCol);
		}
		
		for (var i:int=0; i<_columns.length; i++)
		{
			var prevcol:ExAdvancedDataGridColumn=null;
			var col:ExAdvancedDataGridColumn=ExAdvancedDataGridColumn(_columns[i]);
			
			if(col.merge)
			{
				if(mergedCols.length > 1)
				{
					for (var k:int=0; k<mergedCols.length; k++)
					{
						prevcol=ExAdvancedDataGridColumn(mergedCols[k]);
						if(col.dataField == prevcol.dataField)
							break;
					}
					if(k == 0)
						prevcol = null;
					else
						prevcol = ExAdvancedDataGridColumn(mergedCols[k - 1])
					addMergeCellsArray(col,prevcol,i);
				}
				else
				{
					addMergeCellsArray(col,null,i);
				}
			}
		}
		resetMergedRowNum();
	...
	/*************************************************************
	 * method support to get all merged cells into mergeCell array
	 * @author Duong Pham
	 * ***********************************************************/
	private function addMergeCellsArray(col:ExAdvancedDataGridColumn,prevcol:ExAdvancedDataGridColumn, i:int):void
	{			
		var prevLabel:String="";
		var keepNum:int=-1;
		for (var j:int=0; j<this.dataProvider.length; j++)
		{
			var prevRowData:Object=null;
			var currRowData:Object=this.dataProvider[j];
			var domerge:Boolean=false;
			
			if(j>0)
			{
				prevRowData=this.dataProvider[j-1];
			}
			
			if(currRowData!=null)
			{
				//compare data of previous cell with data in current cell
				if(prevLabel==currRowData[col.dataField])
				{
					var checkPrevColumnLine:MergeCellInfo=null;
					//check whether i=column index, j=row index is not the first index
					if(i>0 && j>0)
					{
						//get info of merge cell in specific row and column index. 
						checkPrevColumnLine=getMergeCell(j-1,i-1);
					}
					//check in case the row which start to merge is the first row to be merge.
					if((prevcol==null || prevRowData==null || (currRowData[prevcol.dataField]==prevRowData[prevcol.dataField])) &&
						(( prevcol == null && checkPrevColumnLine==null) || (checkPrevColumnLine!=null && checkPrevColumnLine.mergeNum>1)))
					{
						if(keepNum==-1)
						{
							keepNum=j-1;
				...
				//check if domerge is true or prev and curr data is not same or it not the last row.
				if(domerge || prevLabel!=currRowData[col.dataField] || j==this.dataProvider.length-1)
				{
					if(keepNum!=-1)
					{
						//true , if j is the last row index , it will start save all item merge cell in mergeCells array
						if(j==this.dataProvider.length-1 && prevLabel==currRowData[col.dataField] && 
							((prevcol == null && checkPrevColumnLine==null) || (checkPrevColumnLine!=null && checkPrevColumnLine.mergeNum>=2)))
						{
							j++;
						}
				...
				prevLabel=currRowData[col.dataField];
			}
			else 
			{
				prevLabel="";
	...
	/*************************************************************
	 * update array which store color of merged cell
	 * @author Duong Pham
	 * ***********************************************************/
	private function resetMergedRowNum():void{
		mergedRowNum=new Array();
		var i:int = dataFieldIndex[ExAdvancedDataGridColumn(mergedCols[0]).dataField];
		var count:int=0;
		var prevCol:int=-1;
		var prevRow:int=-1;
		...
		for (var j:int=0; j<this.getLength(); j++)
		{
	...
	/*************************************************************
	 * visible and invisible these cells are merged
	 * @author Duong Pham
	 * ***********************************************************/
	private function updateMergeFunction():void
	{
		var settedCol:int=-1;
		var settedRow:int=-1;
		var tg:Object;
		...
		for(var i:int=0; i<mergeCells.length; i++)
		{
			...
			tg=getCellItemAt(checkItem.row, checkItem.col);
			if(tg)
			{
				if(settedCol!=checkItem.mergeOwnerCol || settedRow!=checkItem.mergeOwnerRow)
				{
					...
					var hh:Number =this.rowHeight*multiplyNum;					
					var width:Number = Math.min(tg.width, listContent.width - tg.x);
					var height:Number = Math.min(hh, listContent.height - tg.y);
					if(height < hh )
						height = hh;
					tg.setActualSize(width,height);
					
					var pr:Object=Object(tg.parent);
					pr.swapChildrenAt(pr.numChildren-1, pr.getChildIndex(DisplayObject(tg)));
				}
				else if(settedCol==checkItem.mergeOwnerCol && settedRow==checkItem.mergeOwnerRow)
				{
					tg.visible=false;
				}
			}
		...
		var rowBG:Sprite=Sprite(UIComponent(this.getChildAt(3)).getChildAt(0));
		...
		var row:int=0;
		var settednum:int;
		var col:int = dataFieldIndex[ExAdvancedDataGridColumn(mergedCols[0]).dataField];
		settednum=1;
		for (row=0; row<listItems.length; row++)
		{
			...
			if(checkItem==null || settednum==1 || checkItem.col==checkItem.mergeOwnerCol && checkItem.row==checkItem.mergeOwnerRow)
			{
				var toSetColor:int;
				...
				if(rowInfo[row])
					drawRowBackground(rowBG,row,rowInfo[row].y, rowInfo[row].height,colorset[toSetColor % colorset.length], realRowNum);
				settednum++;
			}
			else if(checkItem && checkItem.col==checkItem.mergeOwnerCol && checkItem.row!=checkItem.mergeOwnerRow)
			{
				if(rowInfo[row])
				{
					toSetColor=mergedRowNum[realColNum][realRowNum];
	 ...
	 * color specified and it works in case merge cell
	 * @author Duong Pham
	 * ***********************************************************/
	override protected function drawHighlightIndicator(indicator:Sprite, x:Number, y:Number, width:Number, height:Number, color:uint, itemRenderer:IListItemRenderer):void
	{
		if(mergeCells && mergeCells.length > 0 && isCellSelectionMode())
		{
			var pt:Point = itemRendererToIndices(itemRenderer);
			if (!pt)
				return;
			
			var rowIndex:int = pt.y;
			var columnIndex:int = displayToAbsoluteColumnIndex(pt.x);
			drawMergeCellIndicator(indicator, rowIndex, columnIndex, x, y, width, height, itemRenderer, color);
		}
		else
			super.drawHighlightIndicator(indicator,x,y,width,height,color,itemRenderer);//color
	}
	 ...
	 *  at the position, width and height specified using the
	 *  color specified. It works in case merge cell
	 * @author Duong Pham
	 * ***********************************************************/
	...
	/*************************************************************
	 * Draw a specified cell with background color
	 * @author Duong Pham
	 * ***********************************************************/
	private function drawMergeCellIndicator(indicator:Sprite, rowIndex:int, columnIndex:int, x:Number, y:Number, width:Number, height:Number, itemRenderer:IListItemRenderer, color:uint):void
	{
		var i:int;
		var g:Graphics = Sprite(indicator).graphics;
		var w:Number=0;
		var h:Number=0;
		var updatedHeight:Number =0;
		
		g.clear();
		var numMerges:int = -1;
		var mergedItem:Object = getMergedInfoAt(rowIndex,columnIndex);
		if(mergedItem && mergedItem["item"])
		{
			itemRenderer = mergedItem["item"];
			numMerges = mergedItem["numMerge"];
		}
		
		if(numMerges > 0)	//calculate itemRenderer.height in case numMerge > 0
			itemRenderer.height = this.rowHeight * numMerges;
		var pt:Point=Sprite(indicator).globalToLocal(itemRenderer.parent.localToGlobal(new Point(itemRenderer.x,itemRenderer.y)));
		w = Math.min(itemRenderer.width, listContent.width - pt.x);
		h = Math.min(itemRenderer.height, listContent.height - pt.y);
		if(mergedItem["item"] == null)
			h += 4;
		g.beginFill(color);
		g.drawRect(pt.x, pt.y-2, w, h);
		g.endFill();				
	}
	
	/*************************************************************
	 * get information of previous visible merged item at current cell
	 * @param rowIndex position row index of cell
	 * @param columnIndex position column index of cell
	 * @author Duong Pham
	 * ***********************************************************/
	private function getMergedInfoAt(rowIndex:int,columnIndex:int):Object
	{
		if(mergeCells == null)
			return null;
		
		var numMerge:int=0;
		var _infoMergedItem:Object;
		var ownerRowIndex:int = rowIndex;
		var curCellMergeInfo:MergeCellInfo = getMergeCell(rowIndex,columnIndex);
		if(curCellMergeInfo)
		{
			var mergeOwnerVisibleRowIndex:int;
			var preVisibleMergedItem:IListItemRenderer;
			var item:IListItemRenderer;
			while(rowIndex >= curCellMergeInfo.mergeOwnerRow)
			{
				item = getCellItemAt(rowIndex, columnIndex);
				if(item == null)
					break;
				preVisibleMergedItem = item;
				mergeOwnerVisibleRowIndex = rowIndex;
				rowIndex --;
			}
			if(mergeOwnerVisibleRowIndex >= 0)
			{
				var preVisibleCellMergeInfo:MergeCellInfo;
				preVisibleCellMergeInfo = getMergeCell(mergeOwnerVisibleRowIndex,columnIndex);
				if(preVisibleCellMergeInfo)
				{
					numMerge = preVisibleCellMergeInfo.mergeNum;
					ownerRowIndex = preVisibleCellMergeInfo.mergeOwnerRow;
				}
			}
			else
			{
				numMerge = curCellMergeInfo.mergeNum;
				ownerRowIndex = curCellMergeInfo.mergeOwnerRow;
			}
		}
		_infoMergedItem = { numMerge  : numMerge,  
			item : preVisibleMergedItem ,
			itemRowIndex:mergeOwnerVisibleRowIndex,
			ownerRowIndex: ownerRowIndex, 
			ownerColumnIndex:columnIndex
		};
		return _infoMergedItem;
	}
	
	/*************************************************************
	 * get information of owner visible merged item of current cell
	 * @param rowIndex position row index of cell
	 * @param columnIndex position column index of cell
	 * @param keycode moving by key UP or key DOWN
	 * @author Duong Pham
	 * ***********************************************************/
	private function getOwnerMergeInfoAt(rowIndex:int,columnIndex:int,keycode:uint):Object
	{
		if(mergeCells == null)
			return null;
		...
		{
			var nextMergeVisibleRowIndex:int = rowIndex;
			if(curCellMergeInfo)
			{
				nextMergeVisibleRowIndex = curCellMergeInfo.mergeNum + rowIndex;
				var nextVisibleMergeCellInfo:MergeCellInfo = getMergeCell(nextMergeVisibleRowIndex,columnIndex);
				while(nextVisibleMergeCellInfo && nextVisibleMergeCellInfo.mergeOwnerRow == curCellMergeInfo.mergeOwnerRow)
				{
					nextMergeVisibleRowIndex ++;
					nextVisibleMergeCellInfo = getMergeCell(nextMergeVisibleRowIndex,columnIndex);
				}
				if(nextVisibleMergeCellInfo)
				{
					numMerge = nextVisibleMergeCellInfo.mergeNum;
				}
			}
			else
				nextMergeVisibleRowIndex ++;
			_infoMergedItem = { numMerge  : numMerge,  								
								ownerRowIndex: nextMergeVisibleRowIndex
							};
		}
		else if(keycode == Keyboard.UP)
		{
			var prevMergeVisibleRowIndex:int = rowIndex;
			if(curCellMergeInfo)
			{
				if(curCellMergeInfo.mergeOwnerRow > 0)
					prevMergeVisibleRowIndex = curCellMergeInfo.mergeOwnerRow - 1;
				else
					prevMergeVisibleRowIndex = curCellMergeInfo.mergeOwnerRow;
				var prevVisibleMergeCellInfo:MergeCellInfo = getMergeCell(prevMergeVisibleRowIndex,columnIndex);
				while(prevVisibleMergeCellInfo && prevVisibleMergeCellInfo.mergeOwnerRow == curCellMergeInfo.mergeOwnerRow)
				{
					prevMergeVisibleRowIndex --;
					prevVisibleMergeCellInfo = getMergeCell(prevMergeVisibleRowIndex,columnIndex);
				}
				
				if(prevVisibleMergeCellInfo)
				{
					prevMergeVisibleRowIndex = prevVisibleMergeCellInfo.mergeOwnerRow;
					var parentMergeCellInfo:MergeCellInfo = getMergeCell(prevVisibleMergeCellInfo.mergeOwnerRow,columnIndex);
					if(parentMergeCellInfo)
					{
						numMerge = parentMergeCellInfo.mergeNum;
					}
				}
			}
			else
				prevMergeVisibleRowIndex --;
			_infoMergedItem = { numMerge  : numMerge,  
								ownerRowIndex: prevMergeVisibleRowIndex 
							  };
		}
		return _infoMergedItem;
	}
												  ...
												  unscaledHeight:Number = -1):void
	{
		...
		if(footer.visible && footer.includeInLayout)
		{
	...
	/*************************************************************
	 * renderer footer when grid is renderer
	 * ***********************************************************/		
	override public function invalidateDisplayList():void
	{
		if(this.hasFooterBar && !footer.visible && !footer.includeInLayout)
		{
			footer.visible = true;
			footer.includeInLayout = true;
		}
		if(!this.hasFooterBar && footer && footer.visible && footer.includeInLayout)
		{
			footer.visible = false;
			footer.includeInLayout = false;
		}
		super.invalidateDisplayList();
		if (footer && footer.visible && footer.includeInLayout)
			footer.invalidateDisplayList();
	}
	
	/*************************************************************
	 *  Moves the selection in a vertical direction and horizontal direction in response
     *  to the user selecting items using enter and strEnterNavigate = "nextcell"
     ...
     *  properties, and call the <code>finishCellKeySelection()</code>method when selectCell = 'true'
     *  to update the selection
	 *  @param code uint The key that was pressed (e.g. Keyboard.DOWN or Keyboard.ENTER)
	 *  @param shiftKey boolean <code>true</code> if the shift key was held down when
     *  the keyboard key was pressed.
	 *  @param ctrlKey boolean <code>true</code> if the ctrl key was held down when
     *  the keyboard key was pressed
	 * ***********************************************************/
	private function moveSelectionPosition(code:uint, shiftKey:Boolean, ctrlKey:Boolean):void
	{
		if(strCellClickAction != Global.CELLSELECT)
		{
			if(findNextItemRenderer(shiftKey))
				return;
		}
		
		var index:int = caretIndex;
		var colIndex:int = caretColumnIndex;
		...
		if (!isColumnFullyVisible(colIndex))
			scrollToViewColumn(colIndex, caretColumnIndex);
	...
	/*************************************************************
	 * get height of scroll thumb
	 * @author Duong Pham
	 * ***********************************************************/
	public function getHeightOfScrollThumb():Number
	{
		if (this.verticalScrollBar != null)
		{
			var scrollThumb:Object=this.verticalScrollBar.scrollThumb;
			return scrollThumb.height;
		}
		return 10;
	}

	/*************************************************************
	 * get page size of scroll thumb, this value is used for external scroll bar
	 * @author Duong Pham
	 * ***********************************************************/
	public function getPageSize():Number
	{
		...
		return Math.max(rowCount - lockedRowCount, 1);
	}
		
	/*************************************************************
	 * find position of item renderer under pointer
	 * @param event MouseEvent
	 * @author Duong Pham
	 * ***********************************************************/
	public function getPositionItemRendererUnderPointer(event:MouseEvent):Object
	{
		var item:IListItemRenderer = mouseEventToItemRenderer(event);
		if(!item)
			return null;
		...
		var columnIndex:int = displayToAbsoluteColumnIndex(pt.x);
		return {rowIndex: pt.y, columnIndex: columnIndex};
	}
	
	/**
	 *  @private
	 *  Firstly, item renderer is selected (caretIndex & caretColumn are used). Press ENTER key board and strEnterNavigate = belowCell and editable of column = true
	 *  The next item renderer will be edited.
	 */
	protected function findEditNextItemRenderer(shiftKey:Boolean):void
	{
		if(_selectedColIndex == -1 && caretIndex < 0)
			return ;
		
		if(caretColumnIndex>=0 && _selectedColIndex != caretColumnIndex)
			_selectedColIndex = caretColumnIndex;
		...
		var index:int = caretIndex;
		var colIndex:int = _selectedColIndex;
		if(colIndex < 0)
			colIndex = _columns.length - 1;
		else if (colIndex >= _columns.length)
			colIndex = 0;
		var reason:String = "";
		
		if (_columns[colIndex].editable && _columns[colIndex].visible)
		{
			if (_columns[colIndex].showEditor)// check whether this column is allowed to be show editor or not
			{
				// kill the old edit session
				reason = index == caretIndex ?
					ExAdvancedDataGridEventReason.NEW_COLUMN :
					ExAdvancedDataGridEventReason.NEW_ROW;
				if (!itemEditorInstance || endEdit(reason))
				{
					// send event to create the new one
					var advancedDataGridEvent:ExAdvancedDataGridEvent =
						new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_EDIT_BEGINNING, false, true);
					// ITEM_EDIT events are cancelable
					...
					//Duong modify here
					var rIndex:int = index - this.verticalScrollPosition;
					var cIndex:int = colIndex - this.horizontalScrollPosition;
					advancedDataGridEvent.itemRenderer = IListItemRenderer(listItems[rIndex][cIndex]);
					dispatchEvent(advancedDataGridEvent);
				}
				//Duong modify to update columnIndex and rowIndex
	...
	//Long added on 2013/03/15
	public function getHorizontalScollBar():ScrollBar
	{
		return this.horizontalScrollBar;
	}
	
	//Long added on 2013/03/15
	public function checkHorizontalScollBar():Boolean
	{
	...
	/**
	 *  get visible list item
	 * 
	 */
	public function getVisibleListItem():Array
	{
