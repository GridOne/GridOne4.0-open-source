 ...
 *  <code>backgroundColor</code> style of the associated ExAdvancedDataGrid control.
 *  The default value for the ExAdvancedDataGrid control is <code>0xFFFFFF</code>.
 *  
 *  @langversion 3.0
 ...
 *  The default value is <code>undefined</code>, which means it uses the value of the 
 *  <code>headerStyleName</code> style of the associated ExAdvancedDataGrid control.
 *  The default value for the ExAdvancedDataGrid control is 
...
/**
 *  The ExAdvancedDataGridColumn class describes a column in an ExAdvancedDataGrid control.
 *  There is one ExAdvancedDataGridColumn per displayable column, even if a column
 *  is hidden or off-screen.
 *  The data provider items of an ExAdvancedDataGrid control 
 *  can contain properties that are not displayed,
 *  and therefore, do not need an ExAdvancedDataGridColumn.
 *  An ExAdvancedDataGridColumn allows specification of the color and font of the text
 ...
 *  <li>An ExAdvancedDataGridColumn only holds information about a column;
 *  it is not the parent of the item renderers in the column.</li>
 *  <li>If you specify an ExAdvancedDataGridColumn class without a <code>dataField</code>
 ...
 *  @mxml
 *
 *  <p>You use the <code>&lt;mx.ExAdvancedDataGridColumn&gt;</code> tag to configure a column
 *  of a ExAdvancedDataGrid control.
 *  You specify the <code>&lt;mx.ExAdvancedDataGridColumn&gt;</code> tag as a child
 *  of the <code>columns</code> property in MXML.
 *  The <code>&lt;mx.ExAdvancedDataGridColumn&gt;</code> tag inherits all of the 
 ...
 *    editorYOffset="0"
 *    formatter="null"
 *    headerRenderer="ExAdvancedDataGridHeaderRenderer"
 *    headerText="<i>No default</i>"
 *    headerWordWrap="undefined"
 *    imeMode="null"
 *    itemEditor="TextInput"
 *    itemRenderer="ExAdvancedDataGridItemRenderer"
 ...
 *  @productversion Flex 3
 */
public class ExAdvancedDataGridColumn extends CSSStyleDeclaration implements IIMESupport
{
    ...
    */
	...
	public var comboHeaderProvider:ArrayCollection=new ArrayCollection();
	public var backupValue:Object;
	public var isOpenningCombo:Boolean;
	
	//for Accessibility:=============================================================
	private var _strAccessReaderOrigin:String = "";
	
	public function get strAccessReaderOrigin():String
	{
		return _strAccessReaderOrigin;
	}
	
	public function set strAccessReaderOrigin(value:String):void
	{
		_strAccessReaderOrigin = value;
	}
	
	private var _strAccessReader:String = "";
	
	public function get strAccessReader():String
	{
		return _strAccessReader;
	}
	
	public function set strAccessReader(value:String):void
	{
		_strAccessReader = value;
	}
	
	private var _strAccessReaderHeaderOrigin:String = "";
	
	public function get strAccessReaderHeaderOrigin():String
	{
		return _strAccessReaderHeaderOrigin;
	}
	
	public function set strAccessReaderHeaderOrigin(value:String):void
	{
		_strAccessReaderHeaderOrigin = value;
	}
	
	private var _strAccessReaderHeader:String = "";
	
	public function get strAccessReaderHeader():String
	{
		return _strAccessReaderHeader;
	}
	
	public function set strAccessReaderHeader(value:String):void
	{
		_strAccessReaderHeader = value;
	}
	
	//===============================================================================
	public var replacedStartIndex:int = -1;
	public var replacedLength:int = -1;
	
	public var export:Boolean = true;
	public var importEnable:Boolean = true;
	
	public var dateOutputFormatString:String="YYYY/MM/DD";
	
	public var dateTimeOutputFormatString:String="YYYY/MM/DD HH:NN";
	/**
	 * The format string determines date format of input data.
	 * It is used to output date format correctly.
	 * There are two input formats: YYYYMMDD (only date) and YYYYYMMDDHHNNSS (date and time).
	 * @default YYYMMDD
	 */
	public var dateInputFormatString:String="YYYYMMDD";
	
	public var dateTimeInputFormatString:String="YYYYMMDDHHNN";
	
	public var buttonText:String = "";
	
	[Bindable] public var inputMask:String = "";
	public var editorInputMask :String = "";
	/**
	 * An array of data that bind to combobox when the column has a ComboBox itemRenderer
	 * @default
	 */
	public var listCombo:Object=new Object();
	public var indexComboKeyArr:Array=new Array();
	public var comboKey:String=Global.DEFAULT_COMBO_KEY;
	
	// For NumberFormat =============================================================
	/**
	 * A flag that indicates that the column uses thousands separator.
	 * it is used when the column has the labelFunction property is Number.
	 * @default true
	 */
	 ...
	 * @default 0
	 */
	public var useCurrency:Boolean=false;
	public var strCurrencyBefore:String="";
	public var editorRestrict:String="";
	
	public var strCurrencyAfter:String="";
	[Bindable] public var precision:int=0;
	
	[Bindable] public var checkPrecision:int=int.MAX_VALUE;
	
	public var symbolPrecision:String="0";
	
	[Bindable] public var maxValue:Number=Number.MAX_VALUE;	
	
	
	//Long add 2013/06/16
	public var imageScaleContent:Boolean = true;
	...
	{
		//Thuan process accessibility: Update header type
		if (value != _type)
			strAccessReader = strAccessReader.replace(_type, value);
		
		this._type=value;	
	}
	
	public var isHideByMenu:Boolean=false;
	public var isCheckBoxHeaderRenderer:Boolean = false;
	public var bChangeCellEvent:Boolean =false;
	
	public var arrSelectedCheckbox:ArrayCollection=new ArrayCollection();
	public var isSelectSingleCheckbox:Boolean=false;
	private var _isSelectedCheckboxAll:Boolean=false;		
	public function get isSelectedCheckboxAll():Boolean
	{
		return _isSelectedCheckboxAll;
	}
	[Bindable]
	public function set isSelectedCheckboxAll(value:Boolean):void
	{
		this._isSelectedCheckboxAll=value;
	}
	
	public var showEditor:Boolean=true;
	public var parent:String = "";
	
	public var selectedRadioItem:Object=null;
	
	public var cellActivation:String=Global.ACTIVATE_EDIT;
	/**
	 * An array of data that bind to column when the column has a ImageText itemRenderer
	 * @default
	 */
	public var imageList:Array=[];		
	public var backupImageList:Array;
	public var isUseGridImage:Boolean=false;
	public var imageHeight:int=20;		
	public var imageWidth:int=20;
	
	public var comboRowCount:int = 5;
	
	[Bindable]
	public var isShowCalendar:Boolean=false;
	
	/**
	 * A string of JavaScript function when you want to create your own labelFunction by JavaScript
	 * @default
	 */
	public var JSlabelFunction:String="";
	
	public var orginalMaxLength:String = "";
	public var maxLength:Number=int.MAX_VALUE;
	[Bindable]
	public var editorMaxChars:int;
	
	public var bHDFontCLine:Boolean = false;
	public var bCellFontCLine:Boolean = false;
	
	public var merge:Boolean = false;
	
	//summary bar
	public var subToltalColumn : Boolean = false;		
	public var totalColumn : Boolean = false;		
	public var hasCustomSummaryValue : Boolean = false;		
//	public var labelSubTotal : Boolean = false;
//	public var labelTotal : Boolean = false;
//	public var lstSummaryBar : Dictionary; //using to store all summary bar of column		
	public var summaryBar : SummaryBar;		
	public var strSummaryBarKey : String;
	public var summaryBarFuncText : String;
//	public var summaryBarFunc : String; //using for custom case of summary bar
	public var positionTotalChange : Dictionary= new Dictionary();//using for custom case of summary bar
	public var formatString :String="";
	public var formatType :Dictionary;
	[Bindable] public var summaryBarStyle:Dictionary = new Dictionary();
	
	public var totalRenderer:IFactory;
	public var subTotalRenderer:IFactory;
	
	public var multiComboArr:Array=new Array();
	
	public var footerColumn:ExAdvancedDataGridColumn;		//review here
	//		public var footerBarKey:String;
	public var footerBarFunc : String;
	public var footerText : String="";
	public var footerFormatType:String;
	
	
	//Duong add
	private var _percentWidth:String = "";
	...
	/**
	 * String that specifies the width of a component as a percentage of its parent's size.
	 *  Allowed values are 0%-100%. Setting the width or explicitWidth properties resets this property to "". 
	 * @default "" 
	 * 
	 */
	public function get percentWidth():String
	{
		return _percentWidth;
	}
	public function set percentWidth(value:String):void
	{
		_percentWidth = value;
	}
    
	[Bindable] public var bManualEditCalendar:Boolean=true;
	
	public var alwayKeepFormatCalendar:Boolean=false;
	
	public var excelFormat:String="";
    //--------------------------------------------------------------------------
    //
    //  Constructor
    //
     ...
     *  @productversion Flex 3
     */
    public function ExAdvancedDataGridColumn(columnName:String = null)
    {
        super();
...
//		this.headerRenderer = new ClassFactory(ExAdvancedDataGridHeaderRenderer);
		this.itemEditor = new ClassFactory(MaskedInput);
		this.totalRenderer = new ClassFactory(TotalRenderer);
		this.subTotalRenderer = new ClassFactory(SubTotalRenderer);	
		this.styleFunction = cellStyleFunc;
    }
    ...
    /**
     *  @private
     *  The ExAdvancedDataGrid that owns this column.
     */
    mx_internal var owner:ExAdvancedDataGridBaseEx;
     ...
     *  <code>mx:ExAdvancedDataGridColumn</code> tags.
     */
     ...
     *
     *  <p>The default item renderer is the ExAdvancedDataGridItemRenderer class,
     ...
     *  with the column. 
     *  Each ExAdvancedDataGridColumn control
     ...
     *  By default, the ExAdvancedDataGrid control looks for a property named 
     ...
     *  For the header cell of a column, the Object parameter is of type ExAdvancedDataGridColumn.
     ...
     *  {
     *      if (value is ExAdvancedDataGridColumn)
     *          return "Column Name";
     *                 
     ...
     *  If <code>true</code>, and the ExAdvancedDataGrid's <code>editable</code>
     ...
     *  ExAdvancedDataGrid will not look for the Enter key and move the editor in
     *  response.
    ...
    /**
     *  Text for the header of this column. By default, the ExAdvancedDataGrid
     ...
     *  If <code>undefined</code>, the ExAdvancedDataGrid control's <code>wordWrap</code> property 
     *  is used. 
     ...
     *  ExAdvancedDataGrid control's <code>imeMode</code> property.</p>
     *
     ...
     *
     *  <p>For the ExAdvancedDataGrid control, the method signature has the following form:</p>
     *
     *  <pre>labelFunction(item:Object, column:ExAdvancedDataGridColumn):String</pre>
     *
     *  <p>where <code>item</code> contains the ExAdvancedDataGrid item object, and
     *  <code>column</code> specifies the ExAdvancedDataGrid column.</p>
     *
     ...
     *  If this property and the ExAdvancedDataGrid <code>sortableColumns</code> property 
     *  are both <code>true</code>, the ExAdvancedDataGrid control dispatches a 
     ...
     *
     *  <p>The ExAdvancedDataGrid control uses this function to sort the elements of the data
     ...
     *  If the ExAdvancedDataGrid's <code>horizontalScrollPolicy</code> property 
     *  is <code>false</code>, all visible columns must fit in the displayable 
     *  area, and the ExAdvancedDataGrid will not always honor the width of
     ...
     *  
     *  <pre>function myStyleFunction(data:Object, column:ExAdvancedDataGridColumn):Object</pre>
     *
     *  <p><code>data</code> - data object associated with the item being rendered.</p>
     *  <p><code>column</code> - ExAdvancedDataGridColumn instance with 
    ...
    {
        var parentGrid:ExAdvancedDataGridBaseEx = owner;
        var item:IListItemRenderer = IListItemRenderer(target);

        chain = super.addStyleToProtoChain(chain, target);
        
        // If the target data is a ExAdvancedDataGridColumn and has a data
        // field in its data, then it is a header so add the
        // ExAdvancedDataGrid.headerStyleName object to the head of the proto chain.
        if (item.data && (item.data is ExAdvancedDataGridColumn))
        {
            var s:Object;
    ...
    override public function setStyle(styleProp:String, value:*):void
    {
        ...
        // If this ExAdvancedDataGridColumn didn't previously have a factory, defaultFactory, or
        // overrides object, then this ExAdvancedDataGridColumn hasn't been added to the item
    ...
    /**
     *  @private
     *  Internal function to allow the ExAdvancedDataGrid to set the width of the
     ...
     *  If the ExAdvancedDataGridColumn or its AdvancedDataGrid control 
    ...
    public function itemToLabel(data:Object, withFormatting:Boolean=true):String
    {
		...
		if (this.itemRenderer != null && (this.itemRenderer.newInstance() is ComboRendrerer))
		{				
			for each (var comboData:Array in this.listCombo)
			{
				for each(var item:Object in comboData)
				{
					if (item["value"] == data[this.dataField])
						return item["label"];
				}
			}
		}
		...
		{		
	        label = itemToLabelWithoutFormatting(data);
	        if (withFormatting)
     ...
     *  @private
     *  
     *  This is the original ExAdvancedDataGrid.itemToLabel() that has been wrapped with applyFormatting()
     *  
     */
    private function itemToLabelWithoutFormatting(data:Object):String
    {
        var headerInfo:ExAdvancedDataGridHeaderInfo  = owner.mx_internal::getHeaderInfo(this);
     ...
     *  of the ExAdvancedDataGridColumn class.
    ...
    public function itemToDataTip(data:Object):String
    {
        ...
        if (data is ExAdvancedDataGridColumn)
            return ExAdvancedDataGridColumn(data).headerText;
     ...
     *
     *  @param col ExAdvancedDataGridColumn in which the properties are to be set.
     *
     */
    protected function copyProperties(col:ExAdvancedDataGridColumn):void
    {
        // copy properties
     ...
     *
     *  @return col ExAdvancedDataGridColumn.
     *
     *  
     *  @langversion 3.0
     *  @playerversion Flash 9
     ...
     *  @productversion Flex 3
     */
    public function clone():ExAdvancedDataGridColumn
    {
        // make a new column
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/**
	 * check combo value inside a specified listkey (it is used for cascadecombo)
	 * */
	public function checkComboValueWithListKey(value:String,listKey:String):Boolean
	{
		if(value==null)
			return true;
		var temp:Array = listCombo[listKey];
	 ...
	 * check combo value
	 * */
	public function checkComboValue(value:String):Boolean
	{
		if(value==null)
			return true;
		for each (var temp:Array in listCombo)
		{
			for each (var item:Object in temp)
			{
				if (item["value"] == value)
	...
	public function getLabelFromCombo(value:String):String
	{
	...
	private function cellStyleFunc(data:Object, column:ExAdvancedDataGridColumn):Object
	{
		if(data === null || column == null)
			return null;
		
		var cellStyle:Object;
		if(column && column.owner)
		{
			var keyObj:String;
			var grid:ExAdvancedDataGrid = ExAdvancedDataGrid(column.owner);
			if(grid._cellDict)
			{
				if(data && data.hasOwnProperty(SummaryBarConstant.SUMMARY_BAR_KEY))
				{
					keyObj = data[SummaryBarConstant.SUMMARY_BAR_KEY] + "," + column.dataField;
					cellStyle = grid._cellDict[keyObj];
				}
				else
				{
					keyObj = data[Global.ACTSONE_INTERNAL]+","+column.dataField;
					cellStyle = grid._cellDict[keyObj];
				}
			}
		}
