...
/**
 *  The ExAdvancedDataGridGroupItemRenderer class defines the default item renderer for  
 ...
 *  @productversion Flex 3
 */
public class ExAdvancedDataGridGroupItemRenderer extends UIComponent
                  ...
                  IFontContextComponent
{
     ...
     *  @productversion Flex 3
     */
    public function ExAdvancedDataGridGroupItemRenderer()
    {
        super();
    ...
    */
    ...
    public function set listData(value:BaseListData):void
    {
        ...
        if(_listData)
		{
			listOwner = ExAdvancedDataGrid(_listData.owner);
			column = listOwner.columns[_listData.columnIndex];
		}
        invalidateProperties();
    }
    ...
    override protected function createChildren():void
    {
		...
		addEventListener(MouseEvent.CLICK, mouseClickHandler);		//Duong modify
    }
	
	/**
	 *  handle mouse click event to allow children to be displayed or not when editable of column = false
	 *  @author Duong Pham 
	 */
	protected function mouseClickHandler(event:MouseEvent):void
	{
		if(_listData)
		{
			if(column && !column.editable)
			{
				...
				_listData.open = !open;
				if(listOwner.enableTreeClickAction)
				{
					listOwner.dispatchExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_OPENING,
						_listData.item, //item
						this,   //renderer
						event,  //trigger
						!open,  //opening
    ...
    override protected function commitProperties():void
    {
        ...
        if (_data != null)
        {
            ...
            if (dataTips)
            {
                if (!(_data is ExAdvancedDataGridColumn) && (label.textWidth > label.width
    ...
    */
    ...
    private function disclosureMouseDownHandler(event:Event):void
    {
        ...
        var open:Boolean = _listData.open;
        _listData.open = !open;
        if(listOwner.enableTreeClickAction)		//Duong add to prevent open tree when enableTreeClickAction = false
		{
	        listOwner.dispatchExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_OPENING,
	                                _listData.item, //item
	                                this,   //renderer
