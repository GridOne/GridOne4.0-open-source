...
package kr.co.actsone.controls
{
	...
	import kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridBase;
	import kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridColumn;
	import kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridDragProxy;
	 ...
	 *
	 *  @eventType mx.events.ExAdvancedDataGridEvent.ITEM_EDIT_BEGINNING
	 *  
	 *  @langversion 3.0
	 ...
	 */
	[Event(name="itemEditBeginning", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
	
	/**
	 *  Dispatched when the <code>editedItemPosition</code> property has been set
	 *  and the item can be edited.
	 *
	 *  @eventType mx.events.ExAdvancedDataGridEvent.ITEM_EDIT_BEGIN
	 *  
	 *  @langversion 3.0
	 *  @playerversion Flash 9
	 *  @playerversion AIR 1.1
	 *  @productversion Flex 3
	 */
	[Event(name="itemEditBegin", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
	
	/**
	 *  Dispatched when an item editing session ends for any reason.
	 *
	 *  @eventType mx.events.ExAdvancedDataGridEvent.ITEM_EDIT_END
	 *  
	 *  @langversion 3.0
	 *  @playerversion Flash 9
	 *  @playerversion AIR 1.1
	 *  @productversion Flex 3
	 */
	[Event(name="itemEditEnd", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
	 ...
	 *
	 *  @eventType mx.events.ExAdvancedDataGridEvent.ITEM_FOCUS_IN
	 *  
	 *  @langversion 3.0
	 *  @playerversion Flash 9
	 *  @playerversion AIR 1.1
	 *  @productversion Flex 3
	 */
	[Event(name="itemFocusIn", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
	 ...
	 *
	 *  @eventType mx.events.ExAdvancedDataGridEvent.ITEM_FOCUS_OUT
	 *  
	 *  @langversion 3.0
	 *  @playerversion Flash 9
	 *  @playerversion AIR 1.1
	 *  @productversion Flex 3
	 */
	[Event(name="itemFocusOut", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
	 ...
	 *
	 *  @eventType mx.events.ExAdvancedDataGridEvent.COLUMN_STRETCH
	 *  
	 *  @langversion 3.0
	 *  @playerversion Flash 9
	 *  @playerversion AIR 1.1
	 *  @productversion Flex 3
	 */
	[Event(name="columnStretch", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
	 ...
	 * </p>
	 *
	 *  @eventType mx.events.ExAdvancedDataGridEvent.HEADER_RELEASE
	 *  
	 *  @langversion 3.0
	 *  @playerversion Flash 9
	 *  @playerversion AIR 1.1
	 *  @productversion Flex 3
	 */
	[Event(name="headerRelease", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
	
	/**
	 *  Dispatched when sorting is to be performed on the AdvancedDataGrid control.
	 *
	 *  @eventType mx.events.ExAdvancedDataGridEvent.SORT
	 *  
	 *  @langversion 3.0
	 *  @playerversion Flash 9
	 *  @playerversion AIR 1.1
	 *  @productversion Flex 3
	 */
	[Event(name="sort", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
	...
	/**
	 *  Dispatched when the user press keyboard (Tab/Enter/Left/Right) as soon as property bExternalScroll is TRUE
	 *
	 *  @eventType kr.co.actsone.events.ExAdvancedDataGridEvent
	 *  
	 *  @langversion 3.0
	 *  @playerversion Flash 9
	 *  @playerversion AIR 1.1
	 ...
	 *  @author Duong Pham
	 */
	[Event(name="updateExternalHorizontalScroll", type="kr.co.actsone.events.ExAdvancedDataGridEvent")]
	 ...
	 *  set each one individually.  If you set the ExAdvancedDataGridColumn's itemEditor
	...
	/**
	 *  The class to use as the skin that defines the appearance of the 
	 *  separator between column headers in a ExAdvancedDataGrid control.
	 *  
	 *  <p>The default skin class is based on the theme. For example, with the Halo theme,
	...
	/**
	 * The ExAdvancedDataGridBaseEx class is a base class of the ExAdvancedDataGrid control. 
	 * This class contains code that provides functionality similar to the DataGrid control.
	 * 
	 *  @mxml
	 *  <p>
	 *  The <code>&lt;mx:ExAdvancedDataGridBaseEx&gt;</code> tag inherits all of the tag attributes
	 ...
	 *  @productversion Flex 3
	 */
	public class ExAdvancedDataGridBaseEx extends ExAdvancedDataGridBase implements IIMESupport
	{
		...
		//Duong modify
		[Bindable]
		public var keepValueAfterESC:Boolean = true;
		
		public var isMoveFocusOutSide:Boolean = false;
		
		public var isPressedF2:Boolean=false;
		
		[Bindable] public var bExternalScroll:Boolean = true;
		
		//property to support calculate column with auto. It will be set before calling addHeader
		public var bFlagIgnoreAutoWidthColumn:Boolean = false;
		
		private var _bAutoWidthColumn:Boolean = false;
		public function set bAutoWidthColumn(value:Boolean):void
		{
			_bAutoWidthColumn = value;
			bFlagIgnoreAutoWidthColumn = value;
		}
		
		public function get bAutoWidthColumn():Boolean
		{
			return _bAutoWidthColumn;
		}
		
		public var defaultDataFieldIndex:Object=new Object();
		public var dataFieldIndex:Object=new Object();
		
		//property to support display data as "" in case column Number has data is zero
		public var bDisplayZeroToNull:Boolean = false;
		 ...
		 *  @productversion Flex 3
		 */
		public function ExAdvancedDataGridBaseEx()
		{
			super();
			
			_columns = [];
			
			headerRenderer = new ClassFactory(ExAdvancedDataGridHeaderRenderer);
			sortItemRenderer = new ClassFactory(ExAdvancedDataGridSortItemRenderer);
			...
			addEventListener(ExAdvancedDataGridEvent.ITEM_EDIT_BEGINNING,
				itemEditorItemEditBeginningHandler,
				false, EventPriority.DEFAULT_HANDLER);
			
			addEventListener(ExAdvancedDataGridEvent.ITEM_EDIT_BEGIN,
				itemEditorItemEditBeginHandler,
				false, EventPriority.DEFAULT_HANDLER);
			
			addEventListener(ExAdvancedDataGridEvent.ITEM_EDIT_END,
				itemEditorItemEditEndHandler,
				false, EventPriority.DEFAULT_HANDLER);
			
			addEventListener(ExAdvancedDataGridEvent.HEADER_RELEASE,
				headerReleaseHandler,
				false, EventPriority.DEFAULT_HANDLER);
			
			addEventListener(ExAdvancedDataGridEvent.SORT,
				sortHandler,
				false, EventPriority.DEFAULT_HANDLER);
		 ...
		 */
		private var resizingColumn:ExAdvancedDataGridColumn;
		 ...
		 */
		private var sortColumn:ExAdvancedDataGridColumn;
		 ...
		 */
		protected var movingColumn:ExAdvancedDataGridColumn;
		...
		/**
		 *  An ordered list of ExAdvancedDataGridHeaderInfo instances that 
		 ...
		 * has been initialized with ExAdvancedDataGridHeaderInfo instances.
		 *
		 * @see kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridHeaderInfo 
		 *
		 *  
		 *  @langversion 3.0
		 *  @playerversion Flash 9
		...
		/**
		 *  @public
		 *  array contain information of these cells to be merged
		 *  Duong add
		 */
		public var mergeCells:Array;
 
		/**
		 *  The ExAdvancedDataGridHeaderInfo instances that 
		 ...
		 *  @productversion Flex 3
		 */
		mx_internal var selectedHeaderInfo:ExAdvancedDataGridHeaderInfo;
		
		/***********
		 * @public 
		 * be allow draw row background with dataProvider=null
		 * chheavhun
		 * */
		public var bDrawBgWithDataNull:Boolean=true; //XML cutomer want true; 
		...
		override public function get itemRenderer():IFactory
		{
			if (super.itemRenderer == null)
			{
				...
				if (!c)
					c = ExAdvancedDataGridItemRenderer;
		...
		{
			var image:ExAdvancedDataGridDragProxy = new ExAdvancedDataGridDragProxy();
			image.owner = this;
		 ...
		 *  @private
		 */
		// Added to ExAdvancedDataGridBase
		//private var _columns:Array; // the array of our ExAdvancedDataGridColumns
		
		[Bindable("columnsChanged")]
		[Inspectable(category="General", arrayType="kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridColumn")]
		
		/**
		 *  An array of ExAdvancedDataGridColumn objects, one for each column that
		...
		public function set columns(value:Array):void
		{
			...
			for (i = 0; i < n; i++)
			{
				var column:ExAdvancedDataGridColumn = _columns[i];
				column.owner = this;
				column.colNum = i;
			}
		 ...
		 *
		 *  <p>The <code>ExAdvancedDataGridColumn.itemEditor</code> property defines the
		 ...
		 *  AdvancedDataGrid control using the <code>ExAdvancedDataGridColumn.editable</code> property,
		 ...
		 *  The <code>ExAdvancedDataGridColumn.dataField</code> property of the column
		 *  or the <code>ExAdvancedDataGridColumn.sortCompareFunction</code> property 
		 ...
		 *  AdvancedDataGrid sorts using that column's <code>ExAdvancedDataGridColumn.dataField</code> or  
		 *  <code>ExAdvancedDataGridColumn.sortCompareFunction</code> properties.</p>
		 * 
		 *  @default true
		 *
		 *  @see kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridColumn#dataField
		 *  @see kr.co.actsone.controls.advancedDataGridClasses.ExAdvancedDataGridColumn#sortCompareFunction
		 *  
		 *  @langversion 3.0
		 *  @playerversion Flash 9
		 *  @playerversion AIR 1.1
													   ...
													   byCount:Boolean = false, rowsNeeded:uint = 0):Point
		{
			...
			if (itemEditorInstance)
			{
				...
				var col:ExAdvancedDataGridColumn = optimumColumns[actualColIndex];
		...
		override protected function configureScrollBars():void
		{
			...
			var lastHeaderInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(visibleColumns[visibleColumns.length - 1]);
											   ...
											   transition:Boolean = true):Boolean
		{
			...
			// if item.data is ExAdvancedDataGridColumn, it means that a header is selected
			// selectedItem should be null
			if (item.data is ExAdvancedDataGridColumn)
				_selectedItem = null;
		...
		{
			// if data is ExAdvancedDataGridColumn, it means that a header is selected
			// it should not be added into the list
			if (selectionData.data is ExAdvancedDataGridColumn)
				return ;
		...
		protected function initializeHeaderInfo(a:Array):Array
		{
			...
			for(var i:int = 0; i < n; i++)
			{
				var headerInfo:ExAdvancedDataGridHeaderInfo = new ExAdvancedDataGridHeaderInfo(columns[i],null,i, 0) ;
		 ...
		 *  @private
		 */
		mx_internal function getMeasuringRenderer(c:ExAdvancedDataGridColumn, forHeader:Boolean, data:Object):IListItemRenderer
		{
		...
		mx_internal function setupRendererFromData(c:ExAdvancedDataGridColumn, item:IListItemRenderer, data:Object):void
		{
			var rowData:ExAdvancedDataGridListData =
				ExAdvancedDataGridListData(makeListData(data, itemToUID(data), 0, c.colNum, c));
		...
		protected function calculateHeaderHeight():Number
		{
			...
			if (headerVisible)
			{
				...
				for (j = 0; j < n; j++)
				{
					...
					rowData = ExAdvancedDataGridListData(makeListData(c, uid, 0, c.colNum, c));
		 ...
		 *  @private
		 */
		mx_internal function getHeaderInfo(col:ExAdvancedDataGridColumn):ExAdvancedDataGridHeaderInfo
		{
		 ...
		 *  @private
		 */
		mx_internal function getHeaderInfoAt(colIndex:int):ExAdvancedDataGridHeaderInfo
		{
			if(headerInfos)
										  ...
										  trigger:Event = null):void
		{
			...
			if (newIndex >= 0 && oldIndex != newIndex)
			{
				...
				{
					var j:int = i + incr;
					var c:ExAdvancedDataGridColumn = _columns[i];
			...
			if (collection.length > 0)
			{
				...
				if (!cols)
				{
					...
					for (var p:String in itmObj)
					{
						if (p != "uid")
						{
							col = new ExAdvancedDataGridColumn();
							col.dataField = p;
							newCols.push(col);
						}
					}
		...
		private function calculateColumnSizes():void
		{
			...
			var lastColumn:ExAdvancedDataGridColumn;
			var newSize:Number;
			...
			if (horizontalScrollPolicy == ScrollPolicy.OFF)
			{
				...
				var minWidth:Number;
				if(bFlagIgnoreAutoWidthColumn)
					ratio = 1/visibleColumns.length;
				if (displayWidth > fixedWidth && numResizable)
				{
					...
					for (i = 0; i < n; i++)
					{
						if (visibleColumns[i].resizable && isNaN(visibleColumns[i].explicitWidth))
						{
							...
							if(bAutoWidthColumn && bFlagIgnoreAutoWidthColumn)
							{
								//update column width only one time
								if(isNaN(_columnWidth))
									_columnWidth=lastColumn.width;
							}
							else
								_columnWidth=lastColumn.width;
							...
							if(!bExternalScroll)
								newSize = _columnWidth - (totalWidth - displayWidth) * ratio;
							else
								newSize = _columnWidth;
			...
			else // we have or can have an horizontalScrollBar
			{
					...
					&& newSize > cw)
				{
					...
					if(!checkFixedLastColumnWithHScrollBar())
					{
						...
						//to be used in case width of column is difference explicitWidth
					else if(cw != lastColumn.width)
					{
						lastColumn.setWidth(cw);
					}
				...
				{
					//Duong modify
					if(!isNaN(lastColumn.explicitWidth) && lastColumn.explicitWidth != lastColumn.width)		//to be used in case width of column is difference explicitWidth
					{
						lastColumn.setWidth(cw);
					}
		...
		mx_internal function resizeColumn(col:int, w:Number):void
		{
			...
			else
			{
				...
				var totX:Number = 0;
				//Duong modify to prevent column's width is updated as soon as width has been changed in case using external scroll
				if(!bExternalScroll)
				{
				...
				else if (lastColumn && !bExternalScroll)
				{
		 ...
		 *  even though the index of the ExAdvancedDataGridColumn for that column has changed.
		 *
		 *  @param color The suggested color for the indicator.
		 * 
		...
		protected function drawColumnBackground(s:Sprite, columnIndex:int,
												color:uint, column:ExAdvancedDataGridColumn):void
		{
			var background:Shape;
			...
			var headerInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(getOptimumColumns()[columnIndex]);
		 ...
		 *  @private
		 */
		private function drawHorizontalSeparator(s:Sprite, rowIndex:int, color:uint, y:Number, x:Number=-1, width:Number=-1):void			// Duong update
		{
			...
			else // If we still don't have a sepSkin, then we have no skin style defined. Use the default function instead
			{
				if(x == -1 && width == -1)
					...
					drawHorizontalLineAtPosition(s, rowIndex, color, x, y , width);		// Duong add
			}
		...
		/**
		 *  Draws a line from x position to y position.  This implementation draws a line
		 *  directly into the given Sprite.  The Sprite has been cleared
		 *  before lines are drawn into it.
		 *
		 *  @param s A Sprite that will contain a display object
		 ...
		 *  @param y The suggested y position for the background.
		 *  
		 *  @param width The suggested width for the background.
		 * 
		 *  @langversion 3.0
		 *  @playerversion Flash 9
		 *  @playerversion AIR 1.1
		 *  @productversion Flex 3
		 */
		protected function drawHorizontalLineAtPosition(s:Sprite, rowIndex:int, color:uint, x:Number, y:Number, width:Number):void
		{
			var g:Graphics = s.graphics;
		...
		protected function drawLinesAndColumnBackgrounds():void
		{
			...
			if (headerInfos && hasHeaderItemsCreated(0) && hasHeaderItemsCreated(len-1))
			{
				...
				{
					var col:ExAdvancedDataGridColumn = optimumColumns[i];
					var bgCol:Object;
					if (enabled)
		...
		/*************************************************************
		 * get detail information of merged cell
		 * @param row int index of row
		 * @param col int index of column
		 * @author Duong Pham
		 * ***********************************************************/
		public function getMergeCell(row:int, col:int):MergeCellInfo{
		...
		protected function drawHorizontalSeparators():void
		{
				...
				|| lockedRowCount > 0 && lockedRowCount < listItems.length)
			{
				...
				else
				{
					var item:IListItemRenderer;
					var col:int;
					var cellInfo:MergeCellInfo;
					var currRowIndex:int;
					var currColIndex:int;
					var headerInfo:ExAdvancedDataGridHeaderInfo;
					var xx:Number;
					var optimumColumns:Array = getOptimumColumns();
					var width:int = 0;
					...
					if (getStyle("horizontalGridLines"))
					{
						...
						for (i = 0; i < n; i++)
						{
							for (col=0; col < visibleColumns.length; ++col)
							{
								headerInfo = getHeaderInfo(visibleColumns[col]);
								xx = headerInfo.headerItem.x;
								if(col >= lockedColumnCount)
									xx = getAdjustedXPos(xx);
								currColIndex = col + horizontalScrollPosition;
								currRowIndex = i + verticalScrollPosition;
								cellInfo = getMergeCell(currRowIndex,currColIndex);
								width = headerInfo.headerItem.width;
								if(!(cellInfo && cellInfo.mergeNum != 1))
									drawHorizontalSeparator(lockedLinesBody, i, lineCol, rowInfo[i].y + rowInfo[i].height, xx, width);
							}
						}
					}
					else
					{
						for (col=0; col < visibleColumns.length; ++col)
						{
							...
							width = headerInfo.headerItem.width;
							if(!(cellInfo && cellInfo.mergeNum != 1))
								drawHorizontalSeparator(lockedLinesBody, lockedRowCount - 1 , lineCol, rowInfo[lockedRowCount - 1].y + rowInfo[lockedRowCount - 1].height ,xx, width);
						}
					}
				}
			}
				...
				while (lockedLinesBody.numChildren)
				{
					...
					if (vLines && headerInfos && hasHeaderItemsCreated(0) && hasHeaderItemsCreated(len - 1))
					{
						...
						if (visibleColumns==null || visibleColumns.length==0)
							...
							for (i = lockedColCount; i < newlen; i++)
							{
								var headerInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(visibleColumns[i]);
		...
		protected function drawSeparators():void
		{
			...
			var numUnLockedSeparators:int = Math.max(0, optimumColumns.length);		//Duong modify
			...
			if(!checkFixedLastColumnWithHScrollBar())			//Duong modify
			{
				if (headerLines)
		...
		private function commitEditedItemPosition(coord:Object):void
		{
			...
			if (itemEditorInstance)
			{
				...
				if (!coord)
				{
					reason = ExAdvancedDataGridEventReason.OTHER;
				}
				else
				{
				...
				if (!endEdit(reason) && reason != ExAdvancedDataGridEventReason.OTHER)
					return;
			}
			...
			var headerInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(visibleColumns[visibleColumns.length-1]);
			...
			var event:ExAdvancedDataGridEvent =
				new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_EDIT_BEGIN, false, true);
		...
		public function createItemEditor(colIndex:int, rowIndex:int):void
		{
			...
			// See ExAdvancedDataGridColumn.itemToLabel() regarding formatter.
			if (item is IDropInListItemRenderer)
			...
			if (!col.rendererIsEditor)
			{
				...
				if (!itemEditorInstance)
				{
					...
					if (itemEditor == ExAdvancedDataGridColumn.defaultItemEditorFactory)
					{
		...
		{
			if(_selectedColIndex == -1 && _selectedRowIndex == -1 && !lastEditedItemPosition)
				return false;
			
			//        if (!lastEditedItemPosition)		//Duong comment here
			//            return false;
			...
			while (!found)
			{
				...
				if (colIndex >= _columns.length || colIndex < 0)
				{
					...
					{			
						//Duong comment the original code of advanceddatagrid
						//					if (endEdit(ExAdvancedDataGridEventReason.NEW_ROW))
						//					{
						...
						//Duong modify to keep focus inside datagrid when moving to the last rowIndex and last columnIndex
						return true;
					}
				}
				...
				if (_columns[colIndex].editable && _columns[colIndex].visible)
				{
					if (_columns[colIndex].showEditor)// check whether this column is allowed to be show editor or not
					{
						...
						reason = index == _selectedRowIndex ?
							ExAdvancedDataGridEventReason.NEW_COLUMN :
							ExAdvancedDataGridEventReason.NEW_ROW;
						if (!itemEditorInstance || endEdit(reason))
						{
							...
							advancedDataGridEvent.keyCode = Keyboard.TAB;
							//Duong modify here
							var rIndex:int = index - this.verticalScrollPosition;						
							var cIndex:int = colIndex - this.horizontalScrollPosition;
							var ccIndex:int = getVisibleColumnIndex(cIndex);
							if (listItems[rIndex] && listItems[rIndex][ccIndex])
							{
								advancedDataGridEvent.itemRenderer = IListItemRenderer(listItems[rIndex][ccIndex]);
							}
							dispatchEvent(advancedDataGridEvent);
							//Duong add to update external horizontal scroll
							var externalHScrollAdgEvent:ExAdvancedDataGridEvent =
								new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.UPDATE_EXTERNAL_HORIZONTAL_SCROLL, false, true);
							externalHScrollAdgEvent.columnIndex = colIndex;
							externalHScrollAdgEvent.dataField = _columns[colIndex].dataField;
							externalHScrollAdgEvent.rowIndex = index;
							dispatchEvent(externalHScrollAdgEvent);
						}
					}
				}
			}
		...
		public function destroyItemEditor():void
		{
			...
			if (itemEditorInstance)
			{
				...
				var event:ExAdvancedDataGridEvent =
					new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_FOCUS_OUT);
		 ...
		 *  It dispatches the ExAdvancedDataGridEvent.ITEM_EDIT_END event to start the process
		...
		protected function endEdit(reason:String):Boolean
		{
			...
			//Duong modify
			if(editedItemPosition == null || (!editedItemPosition.hasOwnProperty('columnIndex')) 
				|| (editedItemPosition.columnIndex <0) || (editedItemPosition.columnIndex >= _columns.length))
				return true;
			...
			var advancedDataGridEvent:ExAdvancedDataGridEvent =
				new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_EDIT_END, false, true);
			// ITEM_EDIT events are cancelable
			...
			if (!dontEdit && reason == ExAdvancedDataGridEventReason.CANCELLED)
			{
				losingFocus = true;
				setFocus();
			}
		 ...
		 *  @private
		 */
		mx_internal function columnRendererChanged(c:ExAdvancedDataGridColumn):void
		{
			var item:IListItemRenderer;
		 ...
		 *  @private
		 */
		protected function getPossibleDropPositions(val:ExAdvancedDataGridColumn):Array
		{
		...
		protected function columnDraggingMouseMoveHandler(event:MouseEvent):void
		{
			...
			var item:IListItemRenderer;
			var c:ExAdvancedDataGridColumn = movingColumn;
			var s:Sprite;
			var i:int = 0;
			var n:int;
			if (isNaN(startX))
			{
				...
				var rowData:ExAdvancedDataGridListData = ExAdvancedDataGridListData(makeListData(c, null, 0, c.colNum, c));
				...
				//Duong modify to check i value is greater than orderedHeadersList.length or not
				if(i >= orderedHeadersList.length)
					return;
				...
				if(orderedHeadersList[i].actualColNum >= lockedColumnCount)
				{
					...
					if(horizontalScrollPosition > 0 && orderedHeadersList[i].actualColNum - horizontalScrollPosition < lockedColumnCount)
					{
						...
						if(lockedColumnCount > 0)
						{
							var lastLockedInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(columns[lockedColumnCount-1]);
			...
			if(!dropIndexFound && isHeaderDragOutside == false)
			{
				...
				var advancedDataGridEvent:ExAdvancedDataGridEvent = new ExAdvancedDataGridEvent(
					ExAdvancedDataGridEvent.HEADER_DRAG_OUTSIDE,
					false, true);
				
				var movingColumnInfo:ExAdvancedDataGridHeaderInfo = getHeaderInfo(movingColumn);
		 ...
		 *  @productversion Flex 3
		 */
		protected function isDraggingAllowed(draggedColumn:ExAdvancedDataGridColumn):Boolean
		{
			return draggedColumn.draggable;
		}
		
		/**
		 *  Returns a ExSortInfo instance containing sorting information for the column.
		 *
		 ...
		 *  @productversion Flex 3
		 */
		public function getFieldSortInfo(column:ExAdvancedDataGridColumn):ExSortInfo
		{
		...
		protected function findNextEnterItemRenderer(event:KeyboardEvent):void
		{
			...
			//Duong modify to handle moving between cells by keyboard		
			...
			if(_selectedColIndex <0 && _selectedRowIndex < 0)
				return;
			
			var rowIndex:int = _selectedRowIndex;
			var columnIndex:int = _selectedColIndex;
			var newIndex:int = rowIndex;
			...
			do
			{
				...
				{
					setEditedItemPosition(null);
					//Duong modify here to move item editor to item renderer when user click 'enter' to the last row.
					if(isCellSelectionMode())
					{
						var itemRenderer:IListItemRenderer = IListItemRenderer(listItems[rowIndex - this.verticalScrollPosition][columnIndex - this.horizontalScrollPosition]);
						if(itemRenderer)
						{
							if(caretIndicator)
								caretIndicator = null;
							drawItem(itemRenderer,true,false,true,false);
						}
					}
					return;
				}
			...
			advancedDataGridEvent.keyCode = Keyboard.ENTER;
			//Duong modify here
			var rIndex:int = rowIndex - this.verticalScrollPosition;
			var cIndex:int = columnIndex - this.horizontalScrollPosition;
			var ccIndex:int = getVisibleColumnIndex(cIndex);
			advancedDataGridEvent.itemRenderer = IListItemRenderer(listItems[rIndex][ccIndex]);
			dispatchEvent(advancedDataGridEvent);
			
			//Duong modify
			_selectedColIndex = columnIndex;
		...
		{
			var column:ExAdvancedDataGridColumn = columns[columnNumber];
		...
		{
			// data is set to ExAdvancedDataGridColumn for header items
			if (item != null && item.data is ExAdvancedDataGridColumn)
				return true;
			...
			:int
		{
				...
				newDisplayColumnIndex += offset)
			{
				...
				if (scroll)
				{
					...
					//Duong add to update external scroll when moving LEFT or RIGHT by keyboard
					var externalHScrollAdgEvent:ExAdvancedDataGridEvent =
						new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.UPDATE_EXTERNAL_HORIZONTAL_SCROLL, false, true);
					externalHScrollAdgEvent.columnIndex = newAbsoluteColumnIndex;
					externalHScrollAdgEvent.dataField = _columns[newAbsoluteColumnIndex].dataField;
					externalHScrollAdgEvent.rowIndex = rowIndex;
					dispatchEvent(externalHScrollAdgEvent);
				}
				...
				else
				{
					...
					if (ceEvent.kind == CollectionEventKind.REMOVE)
					{
						if (editedItemPosition)
						{
							...
							{
								if (itemEditorInstance)
									endEdit(ExAdvancedDataGridEventReason.CANCELLED);
		...
		override protected function mouseOutHandler(event:MouseEvent):void
		{
			...
			//			if(!(editedItemRenderer is ImageTextRenderer) || (editedItemRenderer is CalendarRenderer) 
			//				|| (editedItemRenderer is ComboRendrerer) || (editedItemRenderer is ComboDynamicRenderer) 
			//				|| (editedItemRenderer is ImageTextRightRenderer) || (editedItemRenderer is  HideImageTextRightRenderer) && itemEditorInstance)
			//			{
			//				endEdit(ExAdvancedDataGridEventReason.OTHER);
			//			}
		...
		override protected function mouseDownHandler(event:MouseEvent):void
		{
				...
				&& headerVisible && hasHeaderItemsCreated())
			{
				...
				for( var i:int = 0; i < n && r; i++)
				{
					...
					if(headerItem == r)
					{
						var headerInfo:ExAdvancedDataGridHeaderInfo = orderedHeadersList[i];
						
						
						// dispose the editor
						if (itemEditorInstance)
							endEdit(ExAdvancedDataGridEventReason.OTHER);
						var c:ExAdvancedDataGridColumn = orderedHeadersList[i].column;
				...
				if (r && r.data)
				{
					...
					if (itemEditorInstance)
					{
						...
						if (pos == null || displayableColumns[pos.x].editable == false)
							bEndedEdit = endEdit(ExAdvancedDataGridEventReason.OTHER);
						else
		...
		override protected function mouseUpHandler(event:MouseEvent):void
		{
				...
				&& collection && headerVisible && hasHeaderItemsCreated())
			{
				...
				for (i = 0; i < n; i++)
				{
					if (r == orderedHeadersList[i].headerItem && r)
					{
						...
						{
							lastItemDown = null;
							advancedDataGridEvent= new ExAdvancedDataGridEvent(
								ExAdvancedDataGridEvent.HEADER_RELEASE,
								false, true);
				...
				&& isDataEditable(r.data))
			{
				...
				if (pos && pos.y >= 0 && !dontEdit)
				{
					...
					{
						advancedDataGridEvent = new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_EDIT_BEGINNING, false, true);
						// ITEM_EDIT events are cancelable
			...
			{
				//Duong modify to update columnindex and rowIndex
				_selectedColIndex = getColumnIndexByVisibleIndex(pos.x);
				_selectedRowIndex = pos.y;
			}
		...
		override protected function focusInHandler(event:FocusEvent):void
		{
			...
			//Duong modify on 2013/0228 to fix problem in right click in context menu.
			//		if (editable.length && !isPressed)		//orginal code 
			if (editable.length && !isPressed && !(event.relatedObject is DataGrid)) // don't do this if we're mouse focused
			{
				_editedItemPosition = lastEditedItemPosition;
		...
		override protected function keyDownHandler(event:KeyboardEvent):void
		{
			...
			{
				//Duong modify to prevent moving focus to header
			...
			if (event.keyCode != Keyboard.SPACE)
			{
				...
				var saEvent:SAEvent=new SAEvent(SAEvent.ON_ROW_KEYMOVE,true);
				    saEvent.newIndex=caretIndex;
		...
		private function columnResizeMouseOverHandler(event:MouseEvent):void
		{
			...
			var optimumColumns:Array = getOptimumColumns();
			//Duong add
			if(index >= optimumColumns.length)
				return;
		...
		private function columnResizeMouseDownHandler(event:MouseEvent):void
		{
			///////////////////////////////////////////
			//Duong add
			bFlagIgnoreAutoWidthColumn = false;
		...
		private function columnResizeMouseUpHandler(event:Event):void
		{
			...
			var c:ExAdvancedDataGridColumn = resizingColumn;
			resizingColumn = null;
			...
			// event
			var advancedDataGridEvent:ExAdvancedDataGridEvent =
				new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.COLUMN_STRETCH);
			advancedDataGridEvent.columnIndex = c.colNum;
			advancedDataGridEvent.dataField = c.dataField;
		...
		protected function editorKeyDownHandler(event:KeyboardEvent):void
		{
			...
			else if (event.charCode == Keyboard.ENTER && event.keyCode != 229)
			{
				...
				//Duong modify
				// when selectCell=true and selectionMode=edit
				//no need to update editedItemPosition.
				if(strCellClickAction == Global.EDIT && event.charCode == Keyboard.ENTER && strEnterNavigate==Global.STR_ENTER_NAVIGATE_NEXT)
					return;
				...
				if (endEdit(ExAdvancedDataGridEventReason.NEW_ROW) && !dontEdit)
		 ...
		 *  @private
		 */
		private function itemEditorItemEditBeginningHandler(event:ExAdvancedDataGridEvent):void
		{
		 ...
		 *  focus an item renderer in the grid - harder than it looks
		 */
		private function itemEditorItemEditBeginHandler(event:ExAdvancedDataGridEvent):void
		{
			...
			if (!event.isDefaultPrevented() && listItems[actualRowIndex][actualColIndex].data != null)
			{
				...
				//Duong modify to invisible item renderer when item editor is created
				if((editedItemRenderer is ImageTextRenderer) || (editedItemRenderer is CalendarRenderer) 
					|| (editedItemRenderer is ComboRendrerer) || (editedItemRenderer is ComboDynamicRenderer) 
					|| (editedItemRenderer is ImageTextRightRenderer) || (editedItemRenderer is  HideImageTextRightRenderer))
				{
				...
				var event:ExAdvancedDataGridEvent =
					new ExAdvancedDataGridEvent(ExAdvancedDataGridEvent.ITEM_FOCUS_IN);
				event.columnIndex = _editedItemPosition.columnIndex;
				event.rowIndex = _editedItemPosition.rowIndex;
				event.itemRenderer = itemEditorInstance;
				dispatchEvent(event);
				...
				//Duong add
				if(itemEditorInstance is ComboEditor && isPressedF2)
				{
					(itemEditorInstance as ComboEditor).openCombo();
				}
		 ...
		 *  @private
		 */
		private function itemEditorItemEditEndHandler(event:ExAdvancedDataGridEvent):void
		{
			if (!event.isDefaultPrevented())
			{
				...
				if (event.reason == ExAdvancedDataGridEventReason.NEW_COLUMN)
				{
					if (!collectionUpdatesDisabled)
					{
				...
				if (itemEditorInstance && event.reason != ExAdvancedDataGridEventReason.CANCELLED)
				{
					...
					//Duong modify to support display zero to null value
					if(bDisplayZeroToNull && _columns[event.columnIndex].type == ColumnType.NUMBER && data[property] == "0" && newData == "")
					{
						newData = "0";					
					}
					...
					{
						var listData:ExAdvancedDataGridListData = ExAdvancedDataGridListData(IDropInListItemRenderer(event.itemRenderer).listData);
			...
			{
				if (event.reason != ExAdvancedDataGridEventReason.OTHER)
				{
			...
			if (event.reason == ExAdvancedDataGridEventReason.OTHER || !event.isDefaultPrevented())
			{
				destroyItemEditor();
			}
			if((event.itemRenderer is ImageTextRenderer) || (event.itemRenderer is CalendarRenderer)
				||(event.itemRenderer is ComboRendrerer) ||  (event.itemRenderer is ImageTextRightRenderer) 
				|| (event.itemRenderer is ComboDynamicRenderer))
			{
				event.itemRenderer.visible = true;
			}
			
			if ((event.itemRenderer is HideImageTextRightRenderer))
			{
				event.itemRenderer.visible = true;
			}
		}
		...
		public function endEditWithReason(reason:String=null):void
		{
			...
			{
				if (itemEditorInstance)
					endEdit(ExAdvancedDataGridEventReason.NEW_ROW);
			}
		}
		 ...
		 *  @private
		 */
		protected function headerReleaseHandler(event:ExAdvancedDataGridEvent):void
		{
			if (! event.isDefaultPrevented())
			{
				if (itemEditorInstance)
		 ...
		 *  @private
		 */
		protected function sortHandler(event:ExAdvancedDataGridEvent):void
		{
		...
		//	public var strEnterNavigate:String= Global.STR_ENTER_NAVIGATE_NEXT;
		//		public var strEnterNavigate:String= Global.STR_ENTER_NAVIGATE_ACTIVE;
		public var strEnterNavigate:String= Global.STR_ENTER_NAVIGATE_BELOW;
		
		private var _strCellClickAction:String=Global.EDIT;		
		
		public function set strCellClickAction(value:String):void
		{
			_strCellClickAction=value;	
		}
		
		public function get strCellClickAction():String
		{
			return _strCellClickAction;
		}
		
		/**
		 * Handle right click hander to update lastItemDown
		 * @author Duong Pham
		 */
		protected function rightClickHandler(event:MouseEvent):void
		{
			// trace(">>rightClickHandler");
			var r:IListItemRenderer;
			var s:Sprite;
			r = mouseEventToItemRenderer(event);
		...
		/**
		 *  verify visible item renderer  
		 * 
		 */
		override protected function verifyVisibleItemRenderer(item:IListItemRenderer):Boolean
		{
			var isVisible:Boolean = true;
			if(itemEditorInstance && itemEditorInstance is ComboEditor && ComboEditor(itemEditorInstance).listData != null)
			{
				var rIndex:int = ComboEditor(itemEditorInstance).listData.rowIndex;
				var cIndex:int = getVisibleColumnIndex(ComboEditor(itemEditorInstance).listData.columnIndex);
				if(listItems[rIndex] && listItems[rIndex][cIndex])
				{
					var itemRenderer:IListItemRenderer = listItems[rIndex][cIndex];
					if(itemRenderer && itemRenderer == item)
					{
						isVisible = false;
					}
				}
		...
		/**
		 *  @protected
		 *  get column index (follow index of column which as visible and invisible column) from the visible column index
		 * Duong add
		 * 
		 */
		protected function getColumnIndexByVisibleIndex(visibleIndex:int):int
		{
			if(_columns == null || (_columns && _columns.length == 0))
				return -1;
			var columnIndex:int;
			var optimumColumns:Array = getOptimumColumns();
			if(visibleIndex >= optimumColumns.length)
				return -1;
			var dataField:String = ExAdvancedDataGridColumn(optimumColumns[visibleIndex]).dataField;		
			return dataFieldIndex[dataField];
		}
		
		/**
		 *  @protected
		 *  get visible column index according to index in column which has visible and invisible column
		 * Duong add
		 * 
		 */
		protected function getVisibleColumnIndex(originalIndexColumn:int):int
		{
			var dataField:String = this.columns[originalIndexColumn].dataField;
			var optimumColumns:Array = getOptimumColumns();
			var i:int;
			for (i=0; i<optimumColumns.length; i++)
			{
				if(optimumColumns[i].dataField == dataField)
					break;
			}
			return i;
		}
