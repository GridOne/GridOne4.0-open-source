...
package kr.co.actsone.custom
{
	 ...
	 *  @productversion Flex 3
	 */
	public class ExComboBox extends ComboBase
		...
		IListItemRenderer
	{
		...
		public var allowOpenDropDown:Boolean = false;
		//--------------------------------------------------------------------------
		//
		//  Constructor
		//
		...
		{
			if (ExComboBox.createAccessibilityImplementation != null)
				ExComboBox.createAccessibilityImplementation(this);
		}
		...
		private function displayDropdown(show:Boolean, trigger:Event = null, playEffect:Boolean = true):void
		{
			...
			if (show)
			{
				...
				if (!_dropdown.visible && allowOpenDropDown)
