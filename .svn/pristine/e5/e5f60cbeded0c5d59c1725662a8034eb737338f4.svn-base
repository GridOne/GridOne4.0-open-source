...
package kr.co.actsone.custom
{
		 ...
		 */
		public class PrintADG extends ExAdvancedDataGrid
		{
			...
			public function PrintADG()
			{
				...
				this.setStyle("headerColors",bgColor);  
				this.setStyle("groupHDColor",gpHDColor);
			...
			//
			//--------------------------------------------------------------------------
			public var fontColor:Array=[];
			public var bgColor:Array=[];
			public var gpHDColor:Array=[];
			[Bindable]
			public var nHeaderHeight:Number=50;
			//----------------------------------
			//  height
			//----------------------------------
			 ...
			 *  Source ADG.
			 */
			private var _source:ExAdvancedDataGrid;
			 ...
			 *  @productversion Flex 3
			 */
			public function get source():ExAdvancedDataGrid
			{
				return _source;
			}
			 ...
			 *  @private
			 */
			public function set source(value:ExAdvancedDataGrid):void
			{
				_source = value;
				...
				else
				{
					...
					for (i = 0; i < n; i++)
					{
						var sourceColumn:ExAdvancedDataGridColumn = value.columns[i];
						var col:ExAdvancedDataGridColumn = sourceColumn.clone();
			...
			override protected function commitProperties():void
			{
				...
				if (source && source.groupedColumns && source.treeColumn)
				{
					...
					{
						var sourceColumn:ExAdvancedDataGridColumn = source.columns[i];
			 ...
			 */
			override mx_internal function expandItemHandler(event:ExAdvancedDataGridEvent):void
			{
