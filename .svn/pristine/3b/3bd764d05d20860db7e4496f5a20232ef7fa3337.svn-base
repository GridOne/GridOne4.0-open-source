...
package kr.co.actsone.events
{
	...
	/**
	 *   The ExAdvancedDataGridEvent class represents event objects that are specific to
	 *   the AdvancedDataGrid control, such as the event that is dispatched when an 
	 *   editable grid item gets the focus.
	 *
	 *  @see mx.controls.AdvancedDataGrid
	 *  @see mx.events.ExAdvancedDataGridEventReason
	 *  
	 *  @langversion 3.0
	 ...
	 */
	public class ExAdvancedDataGridEvent extends Event
	{
		...
		/**
		 *  The ExAdvancedDataGridEvent.ITEM_CLOSE event type constant indicates that a AdvancedDataGrid
		 ...
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.ITEM_CLOSE</td></tr>
		 *  </table>
		 *
		 *  @eventType itemClose
		 *  
		...
		/**
		 *  The ExAdvancedDataGridEvent.ITEM_EDIT_BEGIN constant defines the value of the 
		 ...
		 *         <td>If the node closed in response to a user action,
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.ITEM_EDIT_BEGIN</td></tr>
		 *  </table>
		 *
		...
		/**
		 *  The ExAdvancedDataGridEvent.ITEM_EDIT_END constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		 ...
		 *       The value must be a member of the <code>ExAdvancedDataGridEventReason</code> class.</td></tr>
		 *     <tr><td><code>removeColumnFromSort</code></td><td><code>false</code></td></tr>
		 *     <tr><td><code>rowIndex</code></td><td>The zero-based index of the 
		 *       item in the data provider.</td></tr>
		 *     <tr><td><code>target</code></td><td>The Object that dispatched the event; 
		 ...
		 *         <td>If the node closed in response to a user action,
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.ITEM_EDIT_END</td></tr>
		 *  </table>
		 *
		...
		/**
		 *  The ExAdvancedDataGridEvent.ITEM_FOCUS_IN constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		 ...
		 *         <td>If the node closed in response to a user action,
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.ITEM_FOCUS_IN</td></tr>
		 *  </table>
		 *
		...
		/**
		 *  The ExAdvancedDataGridEvent.ITEM_FOCUS_OUT constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		 ...
		 *         <td>If the node closed in response to a user action,
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.ITEM_FOCUS_OUT</td></tr>
		 *  </table>
		 *
		...
		/**
		 *  The ExAdvancedDataGridEvent.ITEM__EDIT_BEGINNING constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		 ...
		 *         <td>If the node closed in response to a user action,
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.ITEM_EDIT_BEGINNING</td></tr>
		 *  </table>
		 *
		...
		/**
		 *  The ExAdvancedDataGridEvent.ITEM_OPEN event type constant indicates that an AdvancedDataGrid
		 ...
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.ITEM_OPEN</td></tr>
		 *  </table>
		 *
		 *  @eventType itemOpen
		 *  
		...
		/**
		 *  The ExAdvancedDataGridEvent.ITEM_OPENING event type constant is dispatched immediately 
		 ...
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.ITEM_OPENING</td></tr>
		 *  </table>
		 *
		...
		/**
		 *  The ExAdvancedDataGridEvent.COLUMN_STRETCH constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		 ...
		 *         <td>If the node closed in response to a user action,
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.COLUMN_STRETCH</td></tr>
		 *  </table>
		 *
		...
		/**
		 *  The ExAdvancedDataGridEvent.HEADER_DRAG_OUTSIDE constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		 ...
		 *       Use the <code>currentTarget</code> property to always access the 
		 *       Object listening for the event.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.HEADER_RELEASE</td></tr>
		 *  </table>
		 *
		...
		/**
		 *  The ExAdvancedDataGridEvent.HEADER_DROP_OUTSIDE constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		...
		/**
		 *  The ExAdvancedDataGridEvent.HEADER_RELEASE constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		...
		/**
		 *  The ExAdvancedDataGridEvent.SORT constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		 ...
		 *         <td>If the node closed in response to a user action,
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.SORT</td></tr>
		 *  </table>
		 *
		 * @eventType sort
		 *  
		...
		public static const COMBO_KEY_DOWN:String="COMBO_KEY_DOWN";

		/**
		 *  The ExAdvancedDataGridEvent.UPDATE_EXTERNAL_HORIZONTAL_SCROLL constant defines the value of the 
		 *  <code>type</code> property of the event object for a 
		 *  <code>externalHorizontalScroll</code> event, which indicates that the
		 *  user pressed key board (Tab/Enter/Left/Right) in case bExternalScroll equal true.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 *     <tr><th>Property</th><th>Value</th></tr>
		 ...
		 *     <tr><td><code>cancelable</code></td><td><code>true</code></td></tr>
		 *     <tr><td><code>columnIndex</code></td><td> The zero-based index of the 
		 *       item's column in the ExAdvancedDataGrid object's <code>columns</code> array.</td></tr>
		 *     <tr><td><code>currentTarget</code></td><td>The Object that defines the 
		 *       event listener that handles the event. For example, if you use 
		 *       <code>myButton.addEventListener()</code> to register an event listener, 
		 *       myButton is the value of the <code>currentTarget</code>. </td></tr>
		 *     <tr><td><code>dataField</code></td><td>null</td></tr>
		 *     <tr><td><code>item</code></td><td>The ExAdvancedDataGrid item (node).</td></tr>
		 *     <tr><td><code>itemRenderer</code></td><td>The item renderer for the item
		 *       that is being edited.</td></tr>
		 *     <tr><td><code>localX</code></td><td>NaN</td></tr>
		 *     <tr><td><code>reason</code></td><td>null</td></tr>
		 ...
		 *         <td>If the node closed in response to a user action,
		 *             identifies it as a keyboard action or a mouse action.</td></tr>
		 *     <tr><td><code>type</code></td><td>ExAdvancedDataGridEvent.UPDATE_EXTERNAL_HORIZONTAL_SCROLL</td></tr>
		 *  </table>
		 *
		 *  @eventType externalHorizontalScroll
		 *  
		 *  @langversion 3.0
		 *  @playerversion Flash 9
		 *  @playerversion AIR 1.1
		 ...
		 *  @author Duong Pham
		 */
		public static const UPDATE_EXTERNAL_HORIZONTAL_SCROLL:String = "updateExternalHorizontalScroll";
...
//		public var strOldValue:String="";
		 ...
		 *  @productversion Flex 3
		 */
		public function ExAdvancedDataGridEvent(type:String, bubbles:Boolean = false,
		 ...
		 *  The possible values are defined in the ExAdvancedDataGridEventReason class.
		 * 
		 *  @see ExAdvancedDataGridEventReason
		 *  
		 *  @langversion 3.0
		 *  @playerversion Flash 9
		 *  @playerversion AIR 1.1
		...
		{
			return new ExAdvancedDataGridEvent(type, bubbles, cancelable,
