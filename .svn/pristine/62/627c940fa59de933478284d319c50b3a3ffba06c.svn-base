...
package kr.co.actsone.itemRenderers
{
	...
	public class ImageTextRightRenderer extends ExUIComponent
	{
		...
		public function ImageTextRightRenderer()
		{
			super();
			tabEnabled = false;
													  ...
													  unscaledHeight:Number):void
		{
			...
			if(linkIcon.includeInLayout)
			{
				...
				{
					linkIcon.x = column.width - linkIcon.width-3;
					linkbt.x = startx;
					linkbt.width = column.width - linkIcon.width - startx-5;						
				}
			...
			else
			{
				...
				linkbt.width = column.width - startx-5;
			}
